...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr189f25ec_0 = Thread(target=quickSort, args=(values,start,p))
        thr189f25ec_0.start()
        
        thr189f25ec_1 = Thread(target=quickSort, args=(values,p+1,stop))
        thr189f25ec_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thr5e422485_0 = Thread(target=bubbleSort, args=(values1,))
thr5e422485_0.start()

thr5e422485_1 = Thread(target=quickSort, args=(values2,0,elementCount))
thr5e422485_1.start()

thr5e422485_2 = Thread(target=heapSort, args=(values3,))
thr5e422485_2.start()
