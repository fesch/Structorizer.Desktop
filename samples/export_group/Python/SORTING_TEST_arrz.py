...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thrc989ab11_0 = Thread(target=quickSort, args=(values,start,p))
        thrc989ab11_0.start()
        
        thrc989ab11_1 = Thread(target=quickSort, args=(values,p+1,stop))
        thrc989ab11_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thr9bcafa2b_0 = Thread(target=bubbleSort, args=(values1,))
thr9bcafa2b_0.start()

thr9bcafa2b_1 = Thread(target=quickSort, args=(values2,0,elementCount))
thr9bcafa2b_1.start()

thr9bcafa2b_2 = Thread(target=heapSort, args=(values3,))
thr9bcafa2b_2.start()
