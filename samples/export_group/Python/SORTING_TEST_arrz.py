...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr68b9aebd_0 = Thread(target=quickSort, args=(values,start,p))
        thr68b9aebd_0.start()
        
        thr68b9aebd_1 = Thread(target=quickSort, args=(values,p+1,stop))
        thr68b9aebd_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thrce3f34d1_0 = Thread(target=bubbleSort, args=(values1,))
thrce3f34d1_0.start()

thrce3f34d1_1 = Thread(target=quickSort, args=(values2,0,elementCount))
thrce3f34d1_1.start()

thrce3f34d1_2 = Thread(target=heapSort, args=(values3,))
thrce3f34d1_2.start()
