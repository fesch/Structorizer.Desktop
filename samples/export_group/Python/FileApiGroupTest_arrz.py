...
def drawBarChart(values, nValues) :
    ...
    col29d8b3f5 = turtle.pencolor(); turtle.pencolor("#000000")
    ...
    for k in range(0, nValues-1+1, 1):
        ...
        col55a9d70f = turtle.pencolor(); turtle.pencolor("#000000")
        turtle.fd(1)
        turtle.left(90)
        turtle.pendown()
