...
def drawBarChart(values, nValues) :
    ...
    col31ad85b = turtle.pencolor(); turtle.pencolor("#000000")
    ...
    for k in range(0, nValues-1+1, 1):
        ...
        col989d2b9b = turtle.pencolor(); turtle.pencolor("#000000")
        turtle.fd(1)
        turtle.left(90)
        turtle.pendown()
