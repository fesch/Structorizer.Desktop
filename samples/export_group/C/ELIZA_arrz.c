...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array3b290547[2] = {" i ", " i\'"};
		int index3b290547;
		for (index3b290547 = 0; index3b290547 < 2; index3b290547++) {
			char* word = array3b290547[index3b290547];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count6eef901e = ???;
		int index6eef901e;
		for (index6eef901e = 0; index6eef901e < count6eef901e; index6eef901e++) {
			char* pair[] = phrases[index6eef901e];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count51c5a2d8 = ???;
		int index51c5a2d8;
		for (index51c5a2d8 = 0; index51c5a2d8 < count51c5a2d8; index51c5a2d8++) {
			char* pair[] = flexions[index51c5a2d8];
			left = "";
			right = result;
	...
	// Eliminate multiple spaces (replaced by single ones) and vertical bars 
	{
		char* array4501bf6[2] = {"  ", "|"};
		int index4501bf6;
		for (index4501bf6 = 0; index4501bf6 < 2; index4501bf6++) {
			char* str = array4501bf6[index4501bf6];
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array2762d3c5[5] = {'.', ',', ';', '!', '?'};
		int index2762d3c5;
		for (index2762d3c5 = 0; index2762d3c5 < 5; index2762d3c5++) {
			char symbol = array2762d3c5[index2762d3c5];
