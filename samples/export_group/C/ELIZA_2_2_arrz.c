...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array58cfaaa8[2] = {" i ", " i\'"};
		int index58cfaaa8;
		for (index58cfaaa8 = 0; index58cfaaa8 < 2; index58cfaaa8++) {
			char* word = array58cfaaa8[index58cfaaa8];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count5d31cd19 = ???;
		int index5d31cd19;
		for (index5d31cd19 = 0; index5d31cd19 < count5d31cd19; index5d31cd19++) {
			char* pair[] = phrases[index5d31cd19];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count77fd64e2 = ???;
		int index77fd64e2;
		for (index77fd64e2 = 0; index77fd64e2 < count77fd64e2; index77fd64e2++) {
			char* pair[] = flexions[index77fd64e2];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	sentence = lowercase(sentence);
	{
		char array5387d29[5] = {'.', ',', ';', '!', '?'};
		int index5387d29;
		for (index5387d29 = 0; index5387d29 < 5; index5387d29++) {
			char symbol = array5387d29[index5387d29];
