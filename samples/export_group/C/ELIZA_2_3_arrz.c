...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array17bf55e1[2] = {" i ", " i\'"};
		int index17bf55e1;
		for (index17bf55e1 = 0; index17bf55e1 < 2; index17bf55e1++) {
			char* word = array17bf55e1[index17bf55e1];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count2bc18aa4 = ???;
		int index2bc18aa4;
		for (index2bc18aa4 = 0; index2bc18aa4 < count2bc18aa4; index2bc18aa4++) {
			char* pair[] = phrases[index2bc18aa4];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int countaf41ea06 = ???;
		int indexaf41ea06;
		for (indexaf41ea06 = 0; indexaf41ea06 < countaf41ea06; indexaf41ea06++) {
			char* pair[] = flexions[indexaf41ea06];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array128f3dbd[5] = {'.', ',', ';', '!', '?'};
		int index128f3dbd;
		for (index128f3dbd = 0; index128f3dbd < 5; index128f3dbd++) {
			char symbol = array128f3dbd[index128f3dbd];
