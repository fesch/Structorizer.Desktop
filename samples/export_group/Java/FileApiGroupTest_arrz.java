...
// Copyright (C) 2026-05-03 Kay Gürtzig 
// License: GPLv3-link 
...
public class FileApiGroupTest_arrz {
	...
	public static int readNumbers(String fileName, int[] numbers, int maxNumbers) {
		...
		catch (Exception ex578158b0) {
			String error = ex578158b0.getMessage()
			throw ex578158b0;
		}
		finally {
			fileClose(fileNo);
...
// 			fileClose(fileNo); 
			...
			catch (Exception ex536a295e) {
				String failure = ex536a295e.getMessage()
...
public class DrawRandomHistogram {
	...
	public static void main(String[] args) {
		...
		if (fileNo > 0) {
			...
			catch (Exception ex194e9f38) {
				String failure = ex194e9f38.getMessage()
				System.out.println(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
...
// https://www.gnu.de/documents/gpl-3.0.de.html 
	...
	public static int generateRandomNumberFile(String fileName, int count, int minVal, int maxVal) {
		...
		catch (Exception ex76c54b31) {
			String error = ex76c54b31.getMessage()
