<?php
// includable FileApiGroupTest_arrz (generated by Structorizer 3.30-07) 
...
function generateRandomNumberFile($fileName, $count, $minVal, $maxVal)
{
	...
	} catch (Exception $eexee853b33) {
		$error = $exee853b33->getMessage();
		echo error;
		return -7;
	} finally {
...
<?php
// program DrawRandomHistogram (generated by Structorizer 3.30-07) 
...
if ($fileNo > 0)
{
	...
	} catch (Exception $eex32f18dfb) {
		$failure = $ex32f18dfb->getMessage();
		echo failure;
	}
	if ($nObtained > 0)
	{
