<?php
// includable FileApiGroupTest_arrz (generated by Structorizer 3.32-36) 
...
function generateRandomNumberFile($fileName, $count, $minVal, $maxVal)
{
	...
	} catch (Exception $ex4007f65b) {
		$error = $ex4007f65b->getMessage();
		echo error;
		return -7;
	} finally {
...
<?php
// program DrawRandomHistogram (generated by Structorizer 3.32-36) 
...
if ($fileNo > 0)
{
	...
	} catch (Exception $ex385f8f88) {
		$failure = $ex385f8f88->getMessage();
		echo failure;
	}
	if ($nObtained > 0)
	{
