<?php
// includable FileApiGroupTest_arrz (generated by Structorizer 3.30-11) 
...
function generateRandomNumberFile($fileName, $count, $minVal, $maxVal)
{
	...
	} catch (Exception $eex9cb6fb9a) {
		$error = $ex9cb6fb9a->getMessage();
		echo error;
		return -7;
	} finally {
...
if ($fileNo > 0)
{
	...
	} catch (Exception $eexc8e7b4f7) {
		$failure = $exc8e7b4f7->getMessage();
		echo failure;
	}
	if ($nObtained > 0)
	{
