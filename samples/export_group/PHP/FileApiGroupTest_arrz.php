<?php
// includable FileApiGroupTest_arrz (generated by Structorizer 3.30-08) 

// Copyright (C) 2020-04-23 kay 
...
function generateRandomNumberFile($fileName, $count, $minVal, $maxVal)
{
	...
	} catch (Exception $eex19c13f2) {
		$error = $ex19c13f2->getMessage();
		echo error;
		return -7;
	} finally {
...
function readNumbers($fileName, $numbers, $maxNumbers)
{
	...
	} catch (Exception $eexbce25944) {
		$error = $exbce25944->getMessage();
		throw new Exception();
	} finally {
		StructorizerFileAPI::fileClose($fileNo);
	}
...
<?php
// program ComputeSum (generated by Structorizer 3.30-08) 
...
// 	StructorizerFileAPI::fileClose($fileNo); 
	...
	} catch (Exception $eexe8751d56) {
		$failure = $exe8751d56->getMessage();
		echo failure;
		exit(-7);
	}
	$sum = 0.0;
...
<?php
// program DrawRandomHistogram (generated by Structorizer 3.30-08) 
...
if ($fileNo > 0)
{
	...
	} catch (Exception $eex23ddcbff) {
		$failure = $ex23ddcbff->getMessage();
		echo failure;
	}
	if ($nObtained > 0)
	{
