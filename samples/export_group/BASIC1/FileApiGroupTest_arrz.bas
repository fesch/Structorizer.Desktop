...
Rem Copyright (C) 2026-04-27 Kay Gürtzig 
...
Public Function generateRandomNumberFile(fileName As String, count As Integer, minVal As integer, maxVal As integer) As integer
  ...
  Try
    ...
    Next k
  Catch ex4007f65b As Exception
    Dim error As String = ex4007f65b.ToString()
    PRINT error
    Return -7
  Finally
    fileClose(fileNo)
...
Public Function readNumbers(fileName As String, numbers As integer(50), maxNumbers As integer) As integer
  ...
  Try
    Do While NOT fileEOF(fileNo) AND nNumbers < maxNumbers
      ...
      nNumbers = nNumbers + 1
    Loop
  Catch ex3f9abf83 As Exception
    Dim error As String = ex3f9abf83.ToString()
    Throw 
  Finally
    fileClose(fileNo)
  End Try
...
Rem   fileClose(fileNo) 
  ...
  Catch ex18f612bd As Exception
    Dim failure As String = ex18f612bd.ToString()
    PRINT failure
...
If fileNo > 0 Then
  ...
  Catch ex385f8f88 As Exception
    Dim failure As String = ex385f8f88.ToString()
    PRINT failure
  End Try
  If nObtained > 0 Then
    min = numberArray(0)
