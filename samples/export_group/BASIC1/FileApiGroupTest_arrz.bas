...
Rem Copyright (C) 2020-04-23 kay 
...
Public Function generateRandomNumberFile(fileName AS String, count AS Integer, minVal AS integer, maxVal AS integer) As integer
  ...
  Try
    ...
    Next k
  Catch ex19c13f2 As Exception
    Dim error As String = ex19c13f2.ToString()
    PRINT error
    Return -7
  Finally
    fileClose(fileNo)
...
Public Function readNumbers(fileName AS String, numbers AS array of integer, maxNumbers AS integer) As integer
  ...
  Try
    Do While NOT fileEOF(fileNo) AND nNumbers < maxNumbers
      ...
      nNumbers = nNumbers + 1
    Loop
  Catch exbce25944 As Exception
    Dim error As String = exbce25944.ToString()
    Throw New Exception()
  Finally
    fileClose(fileNo)
  End Try
...
Rem   fileClose(fileNo) 
  ...
  Catch exe8751d56 As Exception
    Dim failure As String = exe8751d56.ToString()
    PRINT failure
    Stop
  End Try
  sum = 0.0
...
If fileNo > 0 Then
  ...
  Catch ex23ddcbff As Exception
    Dim failure As String = ex23ddcbff.ToString()
    PRINT failure
  End Try
  If nObtained > 0 Then
    min = numberArray(0)
