...
Rem Copyright (C) 2020-10-19 Kay Gürtzig 
...
Public Function generateRandomNumberFile(fileName AS String, count AS Integer, minVal AS integer, maxVal AS integer) As integer
  ...
  Try
    ...
    Next k
  Catch ex9cb6fb9a As Exception
    Dim error As String = ex9cb6fb9a.ToString()
    PRINT error
    Return -7
  Finally
    fileClose(fileNo)
...
Public Function readNumbers(fileName AS String, numbers AS array of integer, maxNumbers AS integer) As integer
  ...
  Try
    Do While NOT fileEOF(fileNo) AND nNumbers < maxNumbers
      ...
      nNumbers = nNumbers + 1
    Loop
  Catch ex3fadfdca As Exception
    Dim error As String = ex3fadfdca.ToString()
    Throw New Exception()
  Finally
    fileClose(fileNo)
  End Try
...
Rem   fileClose(fileNo) 
  ...
  Catch ex4cd19982 As Exception
    Dim failure As String = ex4cd19982.ToString()
    PRINT failure
    Stop
  End Try
  sum = 0.0
...
If fileNo > 0 Then
  ...
  Catch exc8e7b4f7 As Exception
    Dim failure As String = exc8e7b4f7.ToString()
    PRINT failure
  End Try
  If nObtained > 0 Then
    min = numberArray(0)
