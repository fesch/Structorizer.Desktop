...
var
  index45de19ec: 1..5;
  array45de19ec: array [1..5] of string;
  index2fe61ff5: 1..2;
  array2fe61ff5: array [1..2] of string;
  index41e7aec9: 1..2;
  array41e7aec9: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array41e7aec9[1] := ' i ';
  array41e7aec9[2] := ' i\''';
  for index41e7aec9 := 1 to 2 do
  begin
    word := array41e7aec9[index41e7aec9];
...
begin
  ...
  array2fe61ff5[1] := ' ';
  array2fe61ff5[2] := '|';
  for index2fe61ff5 := 1 to 2 do
  begin
    str := array2fe61ff5[index2fe61ff5];
...
begin
  ...
  array45de19ec[4] := '!';
  array45de19ec[5] := '?';
  for index45de19ec := 1 to 5 do
  begin
    symbol := array45de19ec[index45de19ec];
