...
var
  indexc43c7cd0: 1..5;
  arrayc43c7cd0: array [1..5] of string;
  indexf98c75dd: 1..2;
  arrayf98c75dd: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arrayf98c75dd[1] := ' i ';
  arrayf98c75dd[2] := ' i\''';
  for indexf98c75dd := 1 to 2 do
  begin
    word := arrayf98c75dd[indexf98c75dd];
...
begin
  ...
  arrayc43c7cd0[4] := '!';
  arrayc43c7cd0[5] := '?';
  for indexc43c7cd0 := 1 to 5 do
  begin
    symbol := arrayc43c7cd0[indexc43c7cd0];
...
var
  replies: array of array of String;
