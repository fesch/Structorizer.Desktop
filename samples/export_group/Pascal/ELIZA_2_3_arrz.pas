...
var
  index3a2c1573: 1..5;
  array3a2c1573: array [1..5] of string;
  index450f7da8: 1..2;
  array450f7da8: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array450f7da8[1] := ' i ';
  array450f7da8[2] := ' i\''';
  for index450f7da8 := 1 to 2 do
  begin
    word := array450f7da8[index450f7da8];
...
begin
  ...
  array3a2c1573[4] := '!';
  array3a2c1573[5] := '?';
  for index3a2c1573 := 1 to 5 do
  begin
    symbol := array3a2c1573[index3a2c1573];
