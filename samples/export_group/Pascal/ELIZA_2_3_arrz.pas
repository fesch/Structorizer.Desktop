...
var
  indexf2009d35: 1..5;
  arrayf2009d35: array [1..5] of string;
  index492b0bb2: 1..2;
  array492b0bb2: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array492b0bb2[1] := ' i ';
  array492b0bb2[2] := ' i\''';
  for index492b0bb2 := 1 to 2 do
  begin
    word := array492b0bb2[index492b0bb2];
...
begin
  ...
  arrayf2009d35[4] := '!';
  arrayf2009d35[5] := '?';
  for indexf2009d35 := 1 to 5 do
  begin
    symbol := arrayf2009d35[indexf2009d35];
