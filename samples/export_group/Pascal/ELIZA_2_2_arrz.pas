...
var
  index5387d29: 1..5;
  array5387d29: array [1..5] of string;
  index58cfaaa8: 1..2;
  array58cfaaa8: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array58cfaaa8[1] := ' i ';
  array58cfaaa8[2] := ' i\''';
  for index58cfaaa8 := 1 to 2 do
  begin
    word := array58cfaaa8[index58cfaaa8];
...
begin
  ...
  array5387d29[4] := '!';
  array5387d29[5] := '?';
  for index5387d29 := 1 to 5 do
  begin
    symbol := array5387d29[index5387d29];
