...
var
  index99919821: 1..5;
  array99919821: array [1..5] of string;
  indexd9fc2314: 1..2;
  arrayd9fc2314: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arrayd9fc2314[1] := ' i ';
  arrayd9fc2314[2] := ' i\''';
  for indexd9fc2314 := 1 to 2 do
  begin
    word := arrayd9fc2314[indexd9fc2314];
...
begin
  ...
  array99919821[4] := '!';
  array99919821[5] := '?';
  for index99919821 := 1 to 5 do
  begin
    symbol := array99919821[index99919821];
