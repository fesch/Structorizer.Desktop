...
var
  index80b588f9: 1..5;
  array80b588f9: array [1..5] of string;
  indexd52b53f: 1..2;
  arrayd52b53f: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arrayd52b53f[1] := ' i ';
  arrayd52b53f[2] := ' i\''';
  for indexd52b53f := 1 to 2 do
  begin
    word := arrayd52b53f[indexd52b53f];
...
begin
  ...
  array80b588f9[4] := '!';
  array80b588f9[5] := '?';
  for index80b588f9 := 1 to 5 do
  begin
    symbol := array80b588f9[index80b588f9];
