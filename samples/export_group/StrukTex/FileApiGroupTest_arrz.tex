...
\begin{struktogramm}(175,183)[ComputeSum]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(337,309)[DrawRandomHistogram]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(234,252)[drawBarChart]
  \assign{%
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(225,128)[generateRandomNumberFile]
  \assign{%
    \begin{declaration}[Parameters:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(223,133)[readNumbers]
  \assign{%
    \begin{declaration}[Parameters:]
      \description{\pVar{fileName}}{type: \(string\)}
