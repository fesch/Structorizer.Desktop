...
\title{Structorizer StrukTeX Export of ELIZA_2.3.arrz}
\author{Kay Gürtzig}
\date{08.06.2021}
...
\begin{struktogramm}(175,123)[adjustSpelling]
  \assign{%
  ...
  \ifthenelse{10}{2}{\(position\ \leq\ length(sentence)\)}{true}{false}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(187,67)[checkGoodBye]
  \assign{%
    \begin{declaration}[Parameters:]
  ...
  \while{\(\forall pair\in phrases\)}
    \ifthenelse{5}{1}{\(pos(pair[0],\ text)\ >\ 0\)}{true}{false}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(270,111)[conjugateStrings]
  \assign{%
    \begin{declaration}[Parameters:]
      \description{\pVar{sentence}}{type: \(string\)}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(247,75)[normalizeInput]
  \assign{%
    \begin{declaration}[Parameters:]
      \description{\pVar{sentence}}{type: \(string\)}
    \end{declaration}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(190,34)[setupGoodByePhrases]
  \assign{%
    \begin{declaration}[Result type:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(117,98)[setupReflexions]
  \assign{%
    \begin{declaration}[Result type:]
      \description{array of array[0..1] of string}{}
    \end{declaration}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(159,590)[setupReplies]
  \assign{%
    \begin{declaration}[Result type:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(175,103)[checkRepetition]
  \assign{%
    \begin{declaration}[Parameters:]
  ...
  % Reduce the ratio arguments or insert an optional height argument if the head got too flat, e.g.: \ifthenelse{3}{3}... or \ifthenelse[10]{10}{2}...
  \ifthenelse{10}{2}{\(length(newInput)\ >\ 4\)}{true}{false}
    ...
    \while{\pKey{for}\(i\ \gets\ 0\)\pKey{to}\(histDepth-1\)}
      ...
      \ifthenelse{3}{1}{\(newInput\ =\ history.histArray[i]\)}{true}{false}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(225,109)[findKeyword]
  \assign{%
    \begin{declaration}[Parameters:]
  ...
  \while{\((result[0]\ <\ 0)\ \wedge\ (i\ <\ length(keyMap))\)}
    ...
    \ifthenelse{5}{1}{\(position\ >\ 0\)}{true}{false}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(136,162)[setupKeywords]
  \assign{%
    \begin{declaration}[Result type:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(317,379)[ELIZA]
  \assign{%
    \begin{declaration}[Requires:]
  ...
  \until{\(isGone\)}
    ...
    \ifthenelse{5}{1}{\(!\ isGone\)}{true}{false}
      ...
      \ifthenelse{3}{1}{\(!\ isRepeated\)}{true}{false}
        ...
        \ifthenelse{1}{1}{\(keyIndex\ <\ 0\)}{true}{false}
        ...
        \assign{\(varPart\ \gets\ \)"{}"{}\(\)}
        % Reduce the ratio arguments or insert an optional height argument if the head got too flat, e.g.: \ifthenelse{3}{3}... or \ifthenelse[10]{1}{1}...
        \ifthenelse{1}{1}{\(length(entry.keyword)\ >\ 0\)}{true}{false}
        ...
        % Reduce the ratio arguments or insert an optional height argument if the head got too flat, e.g.: \ifthenelse{3}{3}... or \ifthenelse[10]{1}{1}...
        \ifthenelse{1}{1}{\(posAster\ >\ 0\)}{true}{false}
          % Reduce the ratio arguments or insert an optional height argument if the head got too flat, e.g.: \ifthenelse{3}{3}... or \ifthenelse[10]{1}{1}...
          \ifthenelse{1}{1}{\(varPart\ =\ \)"{}\ "{}\(\)}{true}{false}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(157,44)[History]
  \assign{%
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(147,31)[KeyMapEntry]
  \assign{%
    \begin{declaration}[type:]
