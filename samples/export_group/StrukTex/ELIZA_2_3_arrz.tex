...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(148,54)[checkGoodBye]
  \assign{%
    \begin{declaration}[Parameters:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(214,90)[conjugateStrings]
  \assign{%
    \begin{declaration}[Parameters:]
      \description{\pVar{sentence}}{type: \(string\)}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(153,27)[setupGoodByePhrases]
  \assign{%
    \begin{declaration}[Result type:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(92,80)[setupReflexions]
  \assign{%
    \begin{declaration}[Result type:]
      \description{array of array[0..1] of string}{}
    \end{declaration}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(134,83)[checkRepetition]
  \assign{%
    \begin{declaration}[Parameters:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(178,86)[findKeyword]
  \assign{%
    \begin{declaration}[Parameters:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(103,130)[setupKeywords]
  \assign{%
    \begin{declaration}[Result type:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(240,305)[ELIZA]
  \assign{%
    \begin{declaration}[Requires:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(124,33)[History]
  \assign{%
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(115,25)[KeyMapEntry]
  \assign{%
    \begin{declaration}[type:]
