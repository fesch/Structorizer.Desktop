...
\begin{struktogramm}(170,107)[adjustSpelling]
  \assign{%
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(183,58)[checkGoodBye]
  \assign{%
    \begin{declaration}[Parameters:]
  ...
  \while{\(\forall pair\in phrases\)}
    ...
    \ifend
  \whileend
  \exit{\(\)\pKey{return}\(\ false\)}
\end{struktogramm}


% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(266,96)[conjugateStrings]
  \assign{%
    \begin{declaration}[Parameters:]
      \description{\pVar{sentence}}{type: \(string\)}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(237,65)[normalizeInput]
  \assign{%
    \begin{declaration}[Parameters:]
      \description{\pVar{sentence}}{type: \(string\)}
    \end{declaration}
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(182,29)[setupGoodByePhrases]
  \assign{%
    \begin{declaration}[Result type:]
  ...
  \exit{\(\)\pKey{return}\(\ phrases\)}
\end{struktogramm}


% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(114,85)[setupReflexions]
  \assign{%
    \begin{declaration}[Result type:]
      \description{array of array[0..1] of string}{}
    \end{declaration}
  ...
  \exit{\(\)\pKey{return}\(\ reflexions\)}
\end{struktogramm}


% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(150,536)[setupReplies]
  \assign{%
    \begin{declaration}[Result type:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(157,89)[checkRepetition]
  \assign{%
    \begin{declaration}[Parameters:]
  ...
  \change
  \ifend
  \exit{\(\)\pKey{return}\(\ hasOccurred\)}
\end{struktogramm}


% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(220,94)[findKeyword]
  \assign{%
    \begin{declaration}[Parameters:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(122,148)[setupKeywords]
  \assign{%
    \begin{declaration}[Result type:]
  ...
  \exit{\(\)\pKey{return}\(\ keywords\)}
\end{struktogramm}


% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(273,331)[ELIZA]
  \assign{%
    \begin{declaration}[Requires:]
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(149,37)[History]
  \assign{%
...
% TODO: Tune the width and height argument if necessary!
\begin{struktogramm}(139,26)[KeyMapEntry]
  \assign{%
    \begin{declaration}[type:]
