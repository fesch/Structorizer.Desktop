...
public class SORTING_TEST_MAIN {
	...
	public static void Main(string[] args) {
		...
		// ========================================================== 
		{
			Worker7e84aaaa_0 worker7e84aaaa_0 = new Worker7e84aaaa_0(values1);
			Thread thr7e84aaaa_0 = new Thread(worker7e84aaaa_0.DoWork);
			thr7e84aaaa_0.Start();
		
			Worker7e84aaaa_1 worker7e84aaaa_1 = new Worker7e84aaaa_1(values2, elementCount);
			Thread thr7e84aaaa_1 = new Thread(worker7e84aaaa_1.DoWork);
			thr7e84aaaa_1.Start();
		
			Worker7e84aaaa_2 worker7e84aaaa_2 = new Worker7e84aaaa_2(values3);
			Thread thr7e84aaaa_2 = new Thread(worker7e84aaaa_2.DoWork);
			thr7e84aaaa_2.Start();
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		...
		if (stop >= start + 2) {
			...
			// ========================================================== 
			{
				Workerb962b98_0 workerb962b98_0 = new Workerb962b98_0(values, start, p);
				Thread thrb962b98_0 = new Thread(workerb962b98_0.DoWork);
				thrb962b98_0.Start();
			
				Workerb962b98_1 workerb962b98_1 = new Workerb962b98_1(values, p, stop);
				Thread thrb962b98_1 = new Thread(workerb962b98_1.DoWork);
				thrb962b98_1.Start();
