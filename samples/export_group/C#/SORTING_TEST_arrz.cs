...
public class SORTING_TEST_MAIN {
	...
	public static void Main(string[] args) {
		...
		// ========================================================== 
		{
			Worker5e422485_0 worker5e422485_0 = new Worker5e422485_0(values1);
			Thread thr5e422485_0 = new Thread(worker5e422485_0.DoWork);
			thr5e422485_0.Start();
		
			Worker5e422485_1 worker5e422485_1 = new Worker5e422485_1(values2, elementCount);
			Thread thr5e422485_1 = new Thread(worker5e422485_1.DoWork);
			thr5e422485_1.Start();
		
			Worker5e422485_2 worker5e422485_2 = new Worker5e422485_2(values3);
			Thread thr5e422485_2 = new Thread(worker5e422485_2.DoWork);
			thr5e422485_2.Start();
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		...
		if (stop >= start + 2) {
			...
			// ========================================================== 
			{
				Worker189f25ec_0 worker189f25ec_0 = new Worker189f25ec_0(values, start, p);
				Thread thr189f25ec_0 = new Thread(worker189f25ec_0.DoWork);
				thr189f25ec_0.Start();
			
				Worker189f25ec_1 worker189f25ec_1 = new Worker189f25ec_1(values, p, stop);
				Thread thr189f25ec_1 = new Thread(worker189f25ec_1.DoWork);
				thr189f25ec_1.Start();
