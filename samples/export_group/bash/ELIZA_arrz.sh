...
function setupGoodByePhrases() {
 ...
 declare -a -g result4082f19=("${phrases[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result741fc835=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result18a255ee=("${setupReplies[@]}")
}
...
function findKeyword() {
 ...
 declare -a -g result31fcd519=("${result[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result20f1933=("${keywords[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${result18a255ee[@]}")
setupReflexions
declare -ar reflexions=("${result741fc835[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result4082f19[@]}")
setupKeywords
declare -ar keyMap=("${result20f1933[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${result31fcd519[@]}")
   keyIndex=${findInfo[0]}
