...
function setupGoodByePhrases() {
    ...
    declare -a -g result175a50ce=("${phrases[@]}")
}
...
function setupReflexions() {
    ...
    declare -a -g result1decb5fd=("${reflexions[@]}")
}
...
function setupReplies() {
    ...
    declare -a -g result448c28e6=("${setupReplies[@]}")
}
...
function findKeyword() {
    ...
    declare -a -g result6aa49957=("${result[@]}")
}
...
function setupKeywords() {
    ...
    declare -a -g result52e9ea3=("${keywords[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${result448c28e6[@]}")
setupReflexions
declare -ar reflexions=("${result1decb5fd[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result175a50ce[@]}")
setupKeywords
declare -ar keyMap=("${result52e9ea3[@]}")
...
do
    ...
    then
        ...
        then
            ...
            declare -a findInfo=("${result6aa49957[@]}")
            keyIndex=${findInfo[0]}
