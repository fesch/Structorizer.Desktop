...
declare -ar replies=("${result7638efee[@]}")
const reflexions <- setupReflexions()
declare -ar reflexions=("${result57869fe7[@]}")
const byePhrases <- setupGoodByePhrases()
declare -ar byePhrases=("${result485bf7b2[@]}")
const keyMap <- setupKeywords()
declare -ar keyMap=("${result2d6f27a5[@]}")
