...
function setupGoodByePhrases() {
 ...
 declare -a -g result8a041f75=("${phrases[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result6d4a1ddd=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result29f34ff8=("${setupReplies[@]}")
}
...
function findKeyword() {
 ...
 declare -a -g result4766ef78=("${result[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resulte6c502f5=("${keywords[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${result29f34ff8[@]}")
setupReflexions
declare -ar reflexions=("${result6d4a1ddd[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result8a041f75[@]}")
setupKeywords
declare -ar keyMap=("${resulte6c502f5[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${result4766ef78[@]}")
   keyIndex=${findInfo[0]}
