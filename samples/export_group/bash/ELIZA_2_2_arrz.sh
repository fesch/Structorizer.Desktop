...
function setupGoodByePhrases() {
 ...
 declare -a -g resulta946faf9=("${phrases[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result903bff40=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resultb2058cef=("${setupReplies[@]}")
}
...
function findKeyword() {
 ...
 declare -a -g resulte08c2ea0=("${result[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resultdc3383d4=("${keywords[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${resultb2058cef[@]}")
setupReflexions
declare -ar reflexions=("${result903bff40[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${resulta946faf9[@]}")
setupKeywords
declare -ar keyMap=("${resultdc3383d4[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${resulte08c2ea0[@]}")
   keyIndex=${findInfo[0]}
