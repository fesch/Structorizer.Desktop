...
function setupGoodByePhrases() {
    ...
    declare -a -g resultd3b15ff=("${phrases[@]}")
}
...
function setupReflexions() {
    ...
    declare -a -g result48a8626b=("${reflexions[@]}")
}
...
function setupReplies() {
    ...
    declare -a -g result57e73f5a=("${setupReplies[@]}")
}
...
function findKeyword() {
    ...
    declare -a -g result7b959739=("${result[@]}")
}
...
function setupKeywords() {
    ...
    declare -a -g result1c4407a0=("${keywords[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${result57e73f5a[@]}")
setupReflexions
declare -ar reflexions=("${result48a8626b[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${resultd3b15ff[@]}")
setupKeywords
declare -ar keyMap=("${result1c4407a0[@]}")
...
do
    ...
    then
        ...
        then
            ...
            declare -a findInfo=("${result7b959739[@]}")
            keyIndex=${findInfo[0]}
