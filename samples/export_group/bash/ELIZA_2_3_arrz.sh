...
function setupGoodByePhrases() {
 ...
 declare -a -g resultc10dc0c8=("${phrases[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result28a069a1=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result5f4dbc6=("${setupReplies[@]}")
}
...
function findKeyword() {
 ...
 declare -a -g resulta4ce6a87=("${result[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result881a8212=("${keywords[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${result5f4dbc6[@]}")
setupReflexions
declare -ar reflexions=("${result28a069a1[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${resultc10dc0c8[@]}")
setupKeywords
declare -ar keyMap=("${result881a8212[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${resulta4ce6a87[@]}")
   keyIndex=${findInfo[0]}
