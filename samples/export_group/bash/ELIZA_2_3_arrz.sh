...
function setupGoodByePhrases() {
 ...
 declare -a -g result7bba067=("${phrases[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result5cde274c=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result6e196073=("${setupReplies[@]}")
}
...
function findKeyword() {
 ...
 declare -a -g result136cc16a=("${result[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result78612f2a=("${keywords[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${result6e196073[@]}")
setupReflexions
declare -ar reflexions=("${result5cde274c[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result7bba067[@]}")
setupKeywords
declare -ar keyMap=("${result78612f2a[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${result136cc16a[@]}")
   keyIndex=${findInfo[0]}
