...
declare -ar replies=("${result1dd2cfda[@]}")
const reflexions <- setupReflexions()
declare -ar reflexions=("${result42d249b4[@]}")
const byePhrases <- setupGoodByePhrases()
declare -ar byePhrases=("${result4e27d8e3[@]}")
const keyMap <- setupKeywords()
declare -ar keyMap=("${resultf3bb176[@]}")
