...
function setupGoodByePhrases() {
 ...
 declare -a -g resultf823ddf1=("${phrases[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g resultf354b2d2=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resulte90e626f=("${setupReplies[@]}")
}
...
function findKeyword() {
 ...
 declare -a -g resultb654278a=("${result[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result6506ebd8=("${keywords[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${resulte90e626f[@]}")
setupReflexions
declare -ar reflexions=("${resultf354b2d2[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${resultf823ddf1[@]}")
setupKeywords
declare -ar keyMap=("${result6506ebd8[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${resultb654278a[@]}")
   keyIndex=${findInfo[0]}
