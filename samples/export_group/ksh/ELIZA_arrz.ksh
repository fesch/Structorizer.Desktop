...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result4082f19 "${phrases[@]}"; export result4082f19
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result741fc835 "${reflexions[@]}"; export result741fc835
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result18a255ee "${setupReplies[@]}"; export result18a255ee
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result31fcd519 "${result[@]}"; export result31fcd519
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result20f1933 "${keywords[@]}"; export result20f1933
}
...
setupReplies
set -A replies "${result18a255ee[@]}"
setupReflexions
set -A reflexions "${result741fc835[@]}"
setupGoodByePhrases
set -A byePhrases "${result4082f19[@]}"
setupKeywords
set -A keyMap "${result20f1933[@]}"
