...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultc10dc0c8 "${phrases[@]}"; export resultc10dc0c8
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result28a069a1 "${reflexions[@]}"; export result28a069a1
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result5f4dbc6 "${setupReplies[@]}"; export result5f4dbc6
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resulta4ce6a87 "${result[@]}"; export resulta4ce6a87
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result881a8212 "${keywords[@]}"; export result881a8212
}
...
setupReplies
set -A replies "${result5f4dbc6[@]}"
setupReflexions
set -A reflexions "${result28a069a1[@]}"
setupGoodByePhrases
set -A byePhrases "${resultc10dc0c8[@]}"
setupKeywords
set -A keyMap "${result881a8212[@]}"
