...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A resultd3b15ff "${phrases[@]}"; export resultd3b15ff
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result48a8626b "${reflexions[@]}"; export result48a8626b
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result57e73f5a "${setupReplies[@]}"; export result57e73f5a
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result7b959739 "${result[@]}"; export result7b959739
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result1c4407a0 "${keywords[@]}"; export result1c4407a0
}
...
setupReplies
set -A replies "${result57e73f5a[@]}"
setupReflexions
set -A reflexions "${result48a8626b[@]}"
setupGoodByePhrases
set -A byePhrases "${resultd3b15ff[@]}"
setupKeywords
set -A keyMap "${result1c4407a0[@]}"
