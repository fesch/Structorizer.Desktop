...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result7bba067 "${phrases[@]}"; export result7bba067
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result5cde274c "${reflexions[@]}"; export result5cde274c
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result6e196073 "${setupReplies[@]}"; export result6e196073
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result136cc16a "${result[@]}"; export result136cc16a
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result78612f2a "${keywords[@]}"; export result78612f2a
}
...
setupReplies
set -A replies "${result6e196073[@]}"
setupReflexions
set -A reflexions "${result5cde274c[@]}"
setupGoodByePhrases
set -A byePhrases "${result7bba067[@]}"
setupKeywords
set -A keyMap "${result78612f2a[@]}"
