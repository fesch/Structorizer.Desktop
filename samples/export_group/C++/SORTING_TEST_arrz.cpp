...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc68b9aebd_0 thrfunc68b9aebd_0;
			std::thread thr68b9aebd_0(thrfunc68b9aebd_0, values, start, p);
		
			ThrFunc68b9aebd_1 thrfunc68b9aebd_1;
			std::thread thr68b9aebd_1(thrfunc68b9aebd_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFuncce3f34d1_0 thrfuncce3f34d1_0;
		std::thread thrce3f34d1_0(thrfuncce3f34d1_0, values1);
	
		ThrFuncce3f34d1_1 thrfuncce3f34d1_1;
		std::thread thrce3f34d1_1(thrfuncce3f34d1_1, values2, elementCount);
	
		ThrFuncce3f34d1_2 thrfuncce3f34d1_2;
		std::thread thrce3f34d1_2(thrfuncce3f34d1_2, values3);
