...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc189f25ec_0 thrfunc189f25ec_0;
			std::thread thr189f25ec_0(thrfunc189f25ec_0, values, start, p);
		
			ThrFunc189f25ec_1 thrfunc189f25ec_1;
			std::thread thr189f25ec_1(thrfunc189f25ec_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFunc5e422485_0 thrfunc5e422485_0;
		std::thread thr5e422485_0(thrfunc5e422485_0, values1);
	
		ThrFunc5e422485_1 thrfunc5e422485_1;
		std::thread thr5e422485_1(thrfunc5e422485_1, values2, elementCount);
	
		ThrFunc5e422485_2 thrfunc5e422485_2;
		std::thread thr5e422485_2(thrfunc5e422485_2, values3);
