...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFuncc989ab11_0 thrfuncc989ab11_0;
			std::thread thrc989ab11_0(thrfuncc989ab11_0, values, start, p);
		
			ThrFuncc989ab11_1 thrfuncc989ab11_1;
			std::thread thrc989ab11_1(thrfuncc989ab11_1, values, p, stop);
...
int main(void)
{
	...
	class ThrFunc9bcafa2b_1{
	public:
		void operator()(??? values2[50], ???& elementCount) {
			quickSort(values2, 0, elementCount);
		}
	};

	class ThrFunc9bcafa2b_2{
	public:
		void operator()(??? values3[50]) {
			heapSort(values3);
		}
	};
	...
	// Parallel section 
	{
		ThrFunc9bcafa2b_0 thrfunc9bcafa2b_0;
		std::thread thr9bcafa2b_0(thrfunc9bcafa2b_0, values1);
	
		ThrFunc9bcafa2b_1 thrfunc9bcafa2b_1;
		std::thread thr9bcafa2b_1(thrfunc9bcafa2b_1, values2, elementCount);
	
		ThrFunc9bcafa2b_2 thrfunc9bcafa2b_2;
		std::thread thr9bcafa2b_2(thrfunc9bcafa2b_2, values3);
