...
int quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc87dcc0ed_0 thrfunc87dcc0ed_0;
			std::thread thr87dcc0ed_0(thrfunc87dcc0ed_0, values, start, p);
		
			ThrFunc87dcc0ed_1 thrfunc87dcc0ed_1;
			std::thread thr87dcc0ed_1(thrfunc87dcc0ed_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFunc882e3cf9_0 thrfunc882e3cf9_0;
		std::thread thr882e3cf9_0(thrfunc882e3cf9_0, values1);
	
		ThrFunc882e3cf9_1 thrfunc882e3cf9_1;
		std::thread thr882e3cf9_1(thrfunc882e3cf9_1, values2, elementCount);
	
		ThrFunc882e3cf9_2 thrfunc882e3cf9_2;
		std::thread thr882e3cf9_2(thrfunc882e3cf9_2, values3);
