...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFuncb962b98_0 thrfuncb962b98_0;
			std::thread thrb962b98_0(thrfuncb962b98_0, values, start, p);
		
			ThrFuncb962b98_1 thrfuncb962b98_1;
			std::thread thrb962b98_1(thrfuncb962b98_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFunc7e84aaaa_0 thrfunc7e84aaaa_0;
		std::thread thr7e84aaaa_0(thrfunc7e84aaaa_0, values1);
	
		ThrFunc7e84aaaa_1 thrfunc7e84aaaa_1;
		std::thread thr7e84aaaa_1(thrfunc7e84aaaa_1, values2, elementCount);
	
		ThrFunc7e84aaaa_2 thrfunc7e84aaaa_2;
		std::thread thr7e84aaaa_2(thrfunc7e84aaaa_2, values3);
