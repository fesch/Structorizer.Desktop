...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result166e1d9c "${result[@]}"; export result166e1d9c
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result6806b631 "${phrases[@]}"; export result6806b631
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultc24464ad "${keywords[@]}"; export resultc24464ad
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result616898e6 "${reflexions[@]}"; export result616898e6
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result3968a0d4 "${setupReplies[@]}"; export result3968a0d4
}
...
set -A history 0 "" "" "" "" ""
setupReplies
set -A replies "${result3968a0d4[@]}"
setupReflexions
set -A reflexions "${result616898e6[@]}"
setupGoodByePhrases
set -A byePhrases "${result6806b631[@]}"
setupKeywords
set -A keyMap "${resultc24464ad[@]}"
