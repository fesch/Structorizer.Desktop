...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result7cf8cd46 "${result[@]}"; export result7cf8cd46
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result41e6ef44 "${phrases[@]}"; export result41e6ef44
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result9b3e76ed "${keywords[@]}"; export result9b3e76ed
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultc29142c7 "${reflexions[@]}"; export resultc29142c7
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result633de6be "${setupReplies[@]}"; export result633de6be
}
...
setupReplies
set -A replies "${result633de6be[@]}"
setupReflexions
set -A reflexions "${resultc29142c7[@]}"
setupGoodByePhrases
set -A byePhrases "${result41e6ef44[@]}"
setupKeywords
set -A keyMap "${result9b3e76ed[@]}"
