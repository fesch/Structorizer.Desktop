...
Rem Generated by Structorizer 3.30-06 
Rem  
...
Function adjustSpelling(sentence AS String) As String
  ...
  End If
  Dim array94bf3fa2() As String = {" i ", " i\'"}
  For Each word In array94bf3fa2
...
Function normalizeInput(sentence AS String) As String
  ...
  Dim array733ab182() As FIXME_733ab182 = {'.', ',', ';', '!', '?'}
  For Each symbol In array733ab182
