...
function findKeyword() {
 ...
 declare -a -g result7cf8cd46=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result41e6ef44=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result9b3e76ed=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g resultc29142c7=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result633de6be=("${setupReplies[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${result633de6be[@]}")
setupReflexions
declare -ar reflexions=("${resultc29142c7[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result41e6ef44[@]}")
setupKeywords
declare -ar keyMap=("${result9b3e76ed[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${result7cf8cd46[@]}")
   keyIndex=${findInfo[0]}
