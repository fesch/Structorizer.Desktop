...
function findKeyword() {
 ...
 declare -a -g resulta4ac2a5c=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result5fab96ca=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result28fbd817=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result51b8010=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result3af4e45f=("${setupReplies[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${result3af4e45f[@]}")
setupReflexions
declare -ar reflexions=("${result51b8010[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result5fab96ca[@]}")
setupKeywords
declare -ar keyMap=("${result28fbd817[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${resulta4ac2a5c[@]}")
   keyIndex=${findInfo[0]}
