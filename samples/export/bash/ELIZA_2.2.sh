...
function findKeyword() {
 ...
 declare -a -g resultdf29f4d5=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result9b99350e=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resulta6873d55=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result4da2bb74=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resultc633dcb0=("${setupReplies[@]}")
}
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${resultc633dcb0[@]}")
setupReflexions
declare -ar reflexions=("${result4da2bb74[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result9b99350e[@]}")
setupKeywords
declare -ar keyMap=("${resulta6873d55[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${resultdf29f4d5[@]}")
   keyIndex=${findInfo[0]}
