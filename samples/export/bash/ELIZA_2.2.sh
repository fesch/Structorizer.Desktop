...
function findKeyword() {
 ...
 declare -a -g result166e1d9c=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result6806b631=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resultc24464ad=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result616898e6=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result3968a0d4=("${setupReplies[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${result3968a0d4[@]}")
setupReflexions
declare -ar reflexions=("${result616898e6[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result6806b631[@]}")
setupKeywords
declare -ar keyMap=("${resultc24464ad[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${result166e1d9c[@]}")
   keyIndex=${findInfo[0]}
