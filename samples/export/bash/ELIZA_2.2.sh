...
function findKeyword() {
 ...
 declare -a -g result98bdaf0c=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result964d8177=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result1f802abc=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result72e1fb5d=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resultfd46aade=("${setupReplies[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${resultfd46aade[@]}")
setupReflexions
declare -ar reflexions=("${result72e1fb5d[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result964d8177[@]}")
setupKeywords
declare -ar keyMap=("${result1f802abc[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${result98bdaf0c[@]}")
   keyIndex=${findInfo[0]}
