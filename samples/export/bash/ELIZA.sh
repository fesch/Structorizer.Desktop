...
function findKeyword() {
 ...
 declare -a -g result9204c596=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g resultc5cb767c=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resultd4a28571=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result4adae07e=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result91cf40e3=("${setupReplies[@]}")
}
# TODO: Check and revise the syntax of all expressions! 
...
setupReplies
declare -ar replies=("${result91cf40e3[@]}")
setupReflexions
declare -ar reflexions=("${result4adae07e[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${resultc5cb767c[@]}")
setupKeywords
declare -ar keyMap=("${resultd4a28571[@]}")
...
do
 ...
 then
  ...
  then
   ...
   declare -a findInfo=("${result9204c596[@]}")
   keyIndex=${findInfo[0]}
