...
public class SORTING_TEST_MAIN {
	...
	public static void Main(string[] args) {
		...
		// ========================================================== 
		{
			Worker9bcafa2b_0 worker9bcafa2b_0 = new Worker9bcafa2b_0(values1);
			Thread thr9bcafa2b_0 = new Thread(worker9bcafa2b_0.DoWork);
			thr9bcafa2b_0.Start();
		
			Worker9bcafa2b_1 worker9bcafa2b_1 = new Worker9bcafa2b_1(values2, elementCount);
			Thread thr9bcafa2b_1 = new Thread(worker9bcafa2b_1.DoWork);
			thr9bcafa2b_1.Start();
		
			Worker9bcafa2b_2 worker9bcafa2b_2 = new Worker9bcafa2b_2(values3);
			Thread thr9bcafa2b_2 = new Thread(worker9bcafa2b_2.DoWork);
			thr9bcafa2b_2.Start();
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		...
		if (stop >= start + 2) {
			...
			// ========================================================== 
			{
				Workerc989ab11_0 workerc989ab11_0 = new Workerc989ab11_0(values, start, p);
				Thread thrc989ab11_0 = new Thread(workerc989ab11_0.DoWork);
				thrc989ab11_0.Start();
			
				Workerc989ab11_1 workerc989ab11_1 = new Workerc989ab11_1(values, p, stop);
				Thread thrc989ab11_1 = new Thread(workerc989ab11_1.DoWork);
				thrc989ab11_1.Start();
