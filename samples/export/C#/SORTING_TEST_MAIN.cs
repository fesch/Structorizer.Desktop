...
public class SORTING_TEST_MAIN {
	...
	public static void Main(string[] args) {
		...
		// ========================================================== 
		{
			Worker882e3cf9_0 worker882e3cf9_0 = new Worker882e3cf9_0(values1);
			Thread thr882e3cf9_0 = new Thread(worker882e3cf9_0.DoWork);
			thr882e3cf9_0.Start();
		
			Worker882e3cf9_1 worker882e3cf9_1 = new Worker882e3cf9_1(values2, elementCount);
			Thread thr882e3cf9_1 = new Thread(worker882e3cf9_1.DoWork);
			thr882e3cf9_1.Start();
		
			Worker882e3cf9_2 worker882e3cf9_2 = new Worker882e3cf9_2(values3);
			Thread thr882e3cf9_2 = new Thread(worker882e3cf9_2.DoWork);
			thr882e3cf9_2.Start();
	...
	private static int quickSort(??? values, ??? start, ??? stop) {
		...
		if (stop >= start + 2) {
			...
			// ========================================================== 
			{
				Worker87dcc0ed_0 worker87dcc0ed_0 = new Worker87dcc0ed_0(values, start, p);
				Thread thr87dcc0ed_0 = new Thread(worker87dcc0ed_0.DoWork);
				thr87dcc0ed_0.Start();
			
				Worker87dcc0ed_1 worker87dcc0ed_1 = new Worker87dcc0ed_1(values, p, stop);
				Thread thr87dcc0ed_1 = new Thread(worker87dcc0ed_1.DoWork);
				thr87dcc0ed_1.Start();
