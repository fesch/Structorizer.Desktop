...
public class SORTING_TEST_MAIN {
	...
	public static void Main(string[] args) {
		...
		// ========================================================== 
		{
			Workerce3f34d1_0 workerce3f34d1_0 = new Workerce3f34d1_0(values1);
			Thread thrce3f34d1_0 = new Thread(workerce3f34d1_0.DoWork);
			thrce3f34d1_0.Start();
		
			Workerce3f34d1_1 workerce3f34d1_1 = new Workerce3f34d1_1(values2, elementCount);
			Thread thrce3f34d1_1 = new Thread(workerce3f34d1_1.DoWork);
			thrce3f34d1_1.Start();
		
			Workerce3f34d1_2 workerce3f34d1_2 = new Workerce3f34d1_2(values3);
			Thread thrce3f34d1_2 = new Thread(workerce3f34d1_2.DoWork);
			thrce3f34d1_2.Start();
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		...
		if (stop >= start + 2) {
			...
			// ========================================================== 
			{
				Worker68b9aebd_0 worker68b9aebd_0 = new Worker68b9aebd_0(values, start, p);
				Thread thr68b9aebd_0 = new Thread(worker68b9aebd_0.DoWork);
				thr68b9aebd_0.Start();
			
				Worker68b9aebd_1 worker68b9aebd_1 = new Worker68b9aebd_1(values, p, stop);
				Thread thr68b9aebd_1 = new Thread(worker68b9aebd_1.DoWork);
				thr68b9aebd_1.Start();
