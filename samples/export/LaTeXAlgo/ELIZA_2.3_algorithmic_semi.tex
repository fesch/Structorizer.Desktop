...
\STATE \COMMENT{ reply ring as defined in `setupReplies()´. }
...
\STATE \COMMENT{ routine `setupKeywords()´ and mapped hitherto by the cross table defined }
\STATE \COMMENT{ in `setupMapping()´ }
