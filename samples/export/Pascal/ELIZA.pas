...
var
  indexee6dc523: 1..5;
  arrayee6dc523: array [1..5] of string;
  indexc1deb5d4: 1..2;
  arrayc1deb5d4: array [1..2] of string;
  index296e052e: 1..2;
  array296e052e: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array296e052e[1] := ' i ';
  array296e052e[2] := ' i\''';
  for index296e052e := 1 to 2 do
  begin
    word := array296e052e[index296e052e];
...
begin
  ...
  arrayc1deb5d4[1] := ' ';
  arrayc1deb5d4[2] := '|';
  for indexc1deb5d4 := 1 to 2 do
  begin
    str := arrayc1deb5d4[indexc1deb5d4];
...
begin
  ...
  arrayee6dc523[4] := '!';
  arrayee6dc523[5] := '?';
  for indexee6dc523 := 1 to 5 do
  begin
    symbol := arrayee6dc523[indexee6dc523];
