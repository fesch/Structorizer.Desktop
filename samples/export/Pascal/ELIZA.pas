...
var
  index39e1ed0e: 1..5;
  array39e1ed0e: array [1..5] of string;
  index310dd16f: 1..2;
  array310dd16f: array [1..2] of string;
  index165aa41d: 1..2;
  array165aa41d: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array165aa41d[1] := ' i ';
  array165aa41d[2] := ' i\''';
  for index165aa41d := 1 to 2 do
  begin
    word := array165aa41d[index165aa41d];
...
begin
  ...
  array310dd16f[1] := ' ';
  array310dd16f[2] := '|';
  for index310dd16f := 1 to 2 do
  begin
    str := array310dd16f[index310dd16f];
...
begin
  ...
  array39e1ed0e[4] := '!';
  array39e1ed0e[5] := '?';
  for index39e1ed0e := 1 to 5 do
  begin
    symbol := array39e1ed0e[index39e1ed0e];
