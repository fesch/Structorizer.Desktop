...
var
  indexcb07562: 1..5;
  arraycb07562: array [1..5] of string;
  index111025d0: 1..2;
  array111025d0: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array111025d0[1] := ' i ';
  array111025d0[2] := ' i\''';
  for index111025d0 := 1 to 2 do
  begin
    word := array111025d0[index111025d0];
...
begin
  ...
  arraycb07562[4] := '!';
  arraycb07562[5] := '?';
  for indexcb07562 := 1 to 5 do
  begin
    symbol := arraycb07562[indexcb07562];
