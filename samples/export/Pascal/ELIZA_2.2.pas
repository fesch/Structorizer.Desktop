...
var
  index733ab182: 1..5;
  array733ab182: array [1..5] of string;
  index94bf3fa2: 1..2;
  array94bf3fa2: array [1..2] of string;
  varPart: String;
...
begin
  ...
  array94bf3fa2[1] := ' i ';
  array94bf3fa2[2] := ' i\''';
  for index94bf3fa2 := 1 to 2 do
  begin
    word := array94bf3fa2[index94bf3fa2];
...
begin
  ...
  array733ab182[4] := '!';
  array733ab182[5] := '?';
  for index733ab182 := 1 to 5 do
  begin
    symbol := array733ab182[index733ab182];
