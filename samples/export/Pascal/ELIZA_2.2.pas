...
var
  index562e19cd: 1..5;
  array562e19cd: array [1..5] of string;
  index11211f0f: 1..2;
  array11211f0f: array [1..2] of string;
  varPart: String;
...
begin
  ...
  array11211f0f[1] := ' i ';
  array11211f0f[2] := ' i\''';
  for index11211f0f := 1 to 2 do
  begin
    word := array11211f0f[index11211f0f];
...
begin
  ...
  array562e19cd[4] := '!';
  array562e19cd[5] := '?';
  for index562e19cd := 1 to 5 do
  begin
    symbol := array562e19cd[index562e19cd];
