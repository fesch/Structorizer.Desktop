...
var
  index9218ddfe: 1..5;
  array9218ddfe: array [1..5] of string;
  indexb8030b03: 1..2;
  arrayb8030b03: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arrayb8030b03[1] := ' i ';
  arrayb8030b03[2] := ' i\''';
  for indexb8030b03 := 1 to 2 do
  begin
    word := arrayb8030b03[indexb8030b03];
...
begin
  ...
  array9218ddfe[4] := '!';
  array9218ddfe[5] := '?';
  for index9218ddfe := 1 to 5 do
  begin
    symbol := array9218ddfe[index9218ddfe];
