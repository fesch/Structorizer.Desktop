...
var
  indexad60b0f8: 1..5;
  arrayad60b0f8: array [1..5] of string;
  index74593207: 1..2;
  array74593207: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array74593207[1] := ' i ';
  array74593207[2] := ' i\''';
  for index74593207 := 1 to 2 do
  begin
    word := array74593207[index74593207];
...
begin
  ...
  arrayad60b0f8[4] := '!';
  arrayad60b0f8[5] := '?';
  for indexad60b0f8 := 1 to 5 do
  begin
    symbol := arrayad60b0f8[indexad60b0f8];
