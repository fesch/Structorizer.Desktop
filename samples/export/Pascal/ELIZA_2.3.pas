...
var
  index2881406f: 1..5;
  array2881406f: array [1..5] of string;
  indexb3ec7986: 1..2;
  arrayb3ec7986: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arrayb3ec7986[1] := ' i ';
  arrayb3ec7986[2] := ' i\''';
  for indexb3ec7986 := 1 to 2 do
  begin
    word := arrayb3ec7986[indexb3ec7986];
...
begin
  ...
  array2881406f[4] := '!';
  array2881406f[5] := '?';
  for index2881406f := 1 to 5 do
  begin
    symbol := array2881406f[index2881406f];
