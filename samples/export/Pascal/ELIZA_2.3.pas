...
var
  index1c98b1c0: 1..5;
  array1c98b1c0: array [1..5] of string;
  index3c2c3624: 1..2;
  array3c2c3624: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array3c2c3624[1] := ' i ';
  array3c2c3624[2] := ' i\''';
  for index3c2c3624 := 1 to 2 do
  begin
    word := array3c2c3624[index3c2c3624];
...
begin
  ...
  array1c98b1c0[4] := '!';
  array1c98b1c0[5] := '?';
  for index1c98b1c0 := 1 to 5 do
  begin
    symbol := array1c98b1c0[index1c98b1c0];
