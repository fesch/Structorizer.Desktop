...
var
  index43d725f7: 1..5;
  array43d725f7: array [1..5] of string;
  indexb4131a24: 1..2;
  arrayb4131a24: array [1..2] of string;
  varPart: String;
...
begin
  ...
  arrayb4131a24[1] := ' i ';
  arrayb4131a24[2] := ' i\''';
  for indexb4131a24 := 1 to 2 do
  begin
    word := arrayb4131a24[indexb4131a24];
...
begin
  ...
  array43d725f7[4] := '!';
  array43d725f7[5] := '?';
  for index43d725f7 := 1 to 5 do
  begin
    symbol := array43d725f7[index43d725f7];
