...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array111025d0[2] = {" i ", " i\'"};
		int index111025d0;
		for (index111025d0 = 0; index111025d0 < 2; index111025d0++) {
			char* word = array111025d0[index111025d0];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count5295402c = ???;
		int index5295402c;
		for (index5295402c = 0; index5295402c < count5295402c; index5295402c++) {
			char* pair[] = phrases[index5295402c];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int countc1c1804a = ???;
		int indexc1c1804a;
		for (indexc1c1804a = 0; indexc1c1804a < countc1c1804a; indexc1c1804a++) {
			char* pair[] = flexions[indexc1c1804a];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	sentence = lowercase(sentence);
	{
		char arraycb07562[5] = {'.', ',', ';', '!', '?'};
		int indexcb07562;
		for (indexcb07562 = 0; indexcb07562 < 5; indexcb07562++) {
			char symbol = arraycb07562[indexcb07562];
