...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array5a9b31db[2] = {" i ", " i\'"};
		int index5a9b31db;
		for (index5a9b31db = 0; index5a9b31db < 2; index5a9b31db++) {
			char* word = array5a9b31db[index5a9b31db];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int counte942aabd = ???;
		int indexe942aabd;
		for (indexe942aabd = 0; indexe942aabd < counte942aabd; indexe942aabd++) {
			char* pair[] = phrases[indexe942aabd];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count7ded26eb = ???;
		int index7ded26eb;
		for (index7ded26eb = 0; index7ded26eb < count7ded26eb; index7ded26eb++) {
			char* pair[] = flexions[index7ded26eb];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arrayee2de2c8[5] = {'.', ',', ';', '!', '?'};
		int indexee2de2c8;
		for (indexee2de2c8 = 0; indexee2de2c8 < 5; indexee2de2c8++) {
			char symbol = arrayee2de2c8[indexee2de2c8];
