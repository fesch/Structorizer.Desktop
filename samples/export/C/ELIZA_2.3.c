...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array492b0bb2[2] = {" i ", " i\'"};
		int index492b0bb2;
		for (index492b0bb2 = 0; index492b0bb2 < 2; index492b0bb2++) {
			char* word = array492b0bb2[index492b0bb2];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count59ec7255 = ???;
		int index59ec7255;
		for (index59ec7255 = 0; index59ec7255 < count59ec7255; index59ec7255++) {
			char* pair[] = phrases[index59ec7255];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int countef20de35 = ???;
		int indexef20de35;
		for (indexef20de35 = 0; indexef20de35 < countef20de35; indexef20de35++) {
			char* pair[] = flexions[indexef20de35];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arrayf2009d35[5] = {'.', ',', ';', '!', '?'};
		int indexf2009d35;
		for (indexf2009d35 = 0; indexf2009d35 < 5; indexf2009d35++) {
			char symbol = arrayf2009d35[indexf2009d35];
