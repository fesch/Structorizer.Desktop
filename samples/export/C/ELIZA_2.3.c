...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* arrayf98c75dd[2] = {" i ", " i\'"};
		int indexf98c75dd;
		for (indexf98c75dd = 0; indexf98c75dd < 2; indexf98c75dd++) {
			char* word = arrayf98c75dd[indexf98c75dd];
...
bool checkGoodBye(char* text, char* phrases[][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int countc8d71970 = ???;
		int indexc8d71970;
		for (indexc8d71970 = 0; indexc8d71970 < countc8d71970; indexc8d71970++) {
			char* pair[] = phrases[indexc8d71970];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count94be84a7 = ???;
		int index94be84a7;
		for (index94be84a7 = 0; index94be84a7 < count94be84a7; index94be84a7++) {
			char* pair[] = flexions[index94be84a7];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arrayc43c7cd0[5] = {'.', ',', ';', '!', '?'};
		int indexc43c7cd0;
		for (indexc43c7cd0 = 0; indexc43c7cd0 < 5; indexc43c7cd0++) {
			char symbol = arrayc43c7cd0[indexc43c7cd0];
