...
120 REM Generated by Structorizer 3.30-07 
130 
...
1030   END IF
1040   DIM arrayf98c75dd() AS String = {" i ", " i\'"}
1050   FOR EACH word IN arrayf98c75dd
...
2100   DIM arrayc43c7cd0() AS FIXME_c43c7cd0 = {'.', ',', ';', '!', '?'}
2110   FOR EACH symbol IN arrayc43c7cd0
