...
1390   LET c = b / sqrt(2.0)
1400   REM inner angle at top of the triangle 
1410   LET angle = toDegrees(atan(1 - 2.0*c/h))
1420   right(90)
1430   penUp()
...
4490   LET rotAngle = toDegrees(atan(width_3/h))
4500   penUp()
...
5700   LET c = (width - b) / 2.0
5710   LET d = b / sqrt(2.0)
5720   penUp()
...
5980   LET c = b / sqrt(2.0)
5990   LET rotAngle = toDegrees(atan(0.5))
6000   LET hypo = c * sqrt(1.25)
6010   penUp()
6020   right(90)
...
6310   LET c = b / sqrt(2.0)
6320   LET angle = toDegrees(atan(h/(h + 2*c)))
6330   penUp()
...
8150   LET c = b / sqrt(2.0)
8160   LET width = h/2.0
8170   LET length1 = h - (b+c)/2.0
8180   LET length2 = length1 - 2*c
8190   LET hypo = sqrt(width*width/16.0 + length2*length2)
8200   REM 360°/8 
8210   LET rotAngle = 45
8220   LET rotAngle2 = toDegrees(atan(width/4.0/length2))
8230   penUp()
...
9480   LET c = b / sqrt(2.0)
9490   REM 360°/8 
9500   LET rotAngle = 45
9510   penUp()
...
10510   LET c = b / sqrt(2.0)
10520   REM 360°/8 
10530   LET rotAngle = 45
10540   penUp()
...
11350   LET c = b / sqrt(2.0)
11360   REM 360°/8 
11370   LET rotAngle = 45
11380   penUp()
...
11710   LET c = b / sqrt(2.0)
11720   REM 360°/8 
11730   LET rotAngle = 45
...
11960   LET c = b / sqrt(2.0)
11970   REM 360°/8 
11980   LET rotAngle = 45
11990   penUp()
...
12260   LET c = b / sqrt(2.0)
12270   REM 360°/8 
12280   LET rotAngle = 45
12290   penUp()
...
12560   LET c = b / sqrt(2.0)
12570   REM 360°/8 
12580   LET rotAngle = 45
12590   penUp()
