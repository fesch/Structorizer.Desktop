...
def drawBarChart(values, nValues) :
    ...
    colafb4b0a = turtle.pencolor(); turtle.pencolor("#000000")
    ...
    for k in range(0, nValues-1+1, 1):
        ...
        col6f90928f = turtle.pencolor(); turtle.pencolor("#000000")
        turtle.fd(1)
        turtle.left(90)
        turtle.pendown()
