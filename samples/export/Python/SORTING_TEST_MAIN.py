...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr87dcc0ed_0 = Thread(target=quickSort, args=(p,start,values))
        thr87dcc0ed_0.start()
        
        thr87dcc0ed_1 = Thread(target=quickSort, args=(stop,p,values))
        thr87dcc0ed_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thr882e3cf9_0 = Thread(target=bubbleSort, args=(values1,))
thr882e3cf9_0.start()

thr882e3cf9_1 = Thread(target=quickSort, args=(elementCount,values2))
thr882e3cf9_1.start()

thr882e3cf9_2 = Thread(target=heapSort, args=(values3,))
thr882e3cf9_2.start()
