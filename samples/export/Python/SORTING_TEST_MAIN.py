...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr1163bb6f_0 = Thread(target=quickSort, args=(p,start,values))
        thr1163bb6f_0.start()
        
        thr1163bb6f_1 = Thread(target=quickSort, args=(stop,p,values))
        thr1163bb6f_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thr3dd09e6b_0 = Thread(target=bubbleSort, args=(values1,))
thr3dd09e6b_0.start()

thr3dd09e6b_1 = Thread(target=quickSort, args=(elementCount,values2))
thr3dd09e6b_1.start()

thr3dd09e6b_2 = Thread(target=heapSort, args=(values3,))
thr3dd09e6b_2.start()
