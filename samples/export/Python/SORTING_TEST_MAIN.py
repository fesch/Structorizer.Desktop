...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr3dfab37d_0 = Thread(target=quickSort, args=(p,start,values))
        thr3dfab37d_0.start()
        
        thr3dfab37d_1 = Thread(target=quickSort, args=(stop,p,values))
        thr3dfab37d_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thr4f085546_0 = Thread(target=bubbleSort, args=(values1,))
thr4f085546_0.start()

thr4f085546_1 = Thread(target=quickSort, args=(elementCount,values2))
thr4f085546_1.start()

thr4f085546_2 = Thread(target=heapSort, args=(values3,))
thr4f085546_2.start()
