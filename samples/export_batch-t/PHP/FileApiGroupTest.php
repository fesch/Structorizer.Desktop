<?php
// function readNumbers (generated by Structorizer 3.32-31) 
...
function readNumbers(fileName: string; numbers: array of integer; maxNumbers: integer): integer()
{
	...
	} catch (Exception $ex467aecef) {
		$error = $ex467aecef->getMessage();
		throw $ex467aecef;
	} finally {
		fileClose(fileNo);
	}
...
<?php
// program ComputeSum (generated by Structorizer 3.32-31) 
...
// 	fileClose(fileNo); 
	...
	} catch (Exception $ex36b4cef0) {
		$failure = $ex36b4cef0->getMessage();
		echo failure;
		exit(-7);
	}
	sum <- 0.0;
...
<?php
// program DrawRandomHistogram (generated by Structorizer 3.32-31) 
require_once 'FileApiGroupTest';
require_once 'StructorizerFileAPI';
...
if (fileNo > 0)
{
	...
	} catch (Exception $ex587d1d39) {
		$failure = $ex587d1d39->getMessage();
		echo failure;
	}
	if (nObtained > 0)
	{
