...
public class readNumbers
{
	...
	public static int readNumbers(String fileName, int[] numbers, int maxNumbers)
	{
		...
		catch (Exception ex15b3e5b)
		{
			String error = ex15b3e5b.getMessage()
			throw ex15b3e5b;
		}
		finally
		{
...
// 			fileClose(fileNo); 
			...
			catch (Exception ex5427c60c)
			{
				String failure = ex5427c60c.getMessage()
...
public class DrawRandomHistogram
{
	...
	public static void main(String[] args)
	{
		...
		if (fileNo > 0)
		{
			...
			catch (Exception ex1e4a7dd4)
			{
				String failure = ex1e4a7dd4.getMessage()
				System.out.println(failure);
			}
			if (nObtained > 0)
			{
