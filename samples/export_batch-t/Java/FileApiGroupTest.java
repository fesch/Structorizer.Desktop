...
public class readNumbers {
	...
	public static int readNumbers(String fileName, int[] numbers, int maxNumbers) {
		...
		catch (Exception ex701fc37a) {
			String error = ex701fc37a.getMessage()
			throw ex701fc37a;
		}
		finally {
			fileClose(fileNo);
...
// 			fileClose(fileNo); 
			...
			catch (Exception ex120d6fe6) {
				String failure = ex120d6fe6.getMessage()
...
public class DrawRandomHistogram {
	...
	public static void main(String[] args) {
		...
		if (fileNo > 0) {
			...
			catch (Exception ex10b48321) {
				String failure = ex10b48321.getMessage()
				System.out.println(failure);
			}
			if (nObtained > 0) {
				min <- numberArray[0];
