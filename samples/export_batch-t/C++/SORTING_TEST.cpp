...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2)
	{
		...
		// Parallel section 
		{
			ThrFunc536aaa8d_0 thrfunc536aaa8d_0;
			std::thread thr536aaa8d_0(thrfunc536aaa8d_0, values, start, p);
		
			ThrFunc536aaa8d_1 thrfunc536aaa8d_1;
			std::thread thr536aaa8d_1(thrfunc536aaa8d_1, values, p, stop);
...
int main(void)
{
	...
	class ThrFunc184f6be2_1{
	public:
		void operator()(int values2[], ???& elementCount) {
			quickSort(values2, 0, elementCount);
		}
	};

	class ThrFunc184f6be2_2{
	public:
		void operator()(int values3[]) {
			heapSort(values3);
		}
	};
	...
	// Parallel section 
	{
		ThrFunc184f6be2_0 thrfunc184f6be2_0;
		std::thread thr184f6be2_0(thrfunc184f6be2_0, values1);
	
		ThrFunc184f6be2_1 thrfunc184f6be2_1;
		std::thread thr184f6be2_1(thrfunc184f6be2_1, values2, elementCount);
	
		ThrFunc184f6be2_2 thrfunc184f6be2_2;
		std::thread thr184f6be2_2(thrfunc184f6be2_2, values3);
