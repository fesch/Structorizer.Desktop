...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc63440df3_0 thrfunc63440df3_0;
			std::thread thr63440df3_0(thrfunc63440df3_0, values, start, p);
		
			ThrFunc63440df3_1 thrfunc63440df3_1;
			std::thread thr63440df3_1(thrfunc63440df3_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFunc7113b13f_0 thrfunc7113b13f_0;
		std::thread thr7113b13f_0(thrfunc7113b13f_0, values1);
	
		ThrFunc7113b13f_1 thrfunc7113b13f_1;
		std::thread thr7113b13f_1(thrfunc7113b13f_1, values2, elementCount);
	
		ThrFunc7113b13f_2 thrfunc7113b13f_2;
		std::thread thr7113b13f_2(thrfunc7113b13f_2, values3);
