...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr76a4d6c_0 = Thread(target=quickSort, args=(values,start,p))
        thr76a4d6c_0.start()
        
        thr76a4d6c_1 = Thread(target=quickSort, args=(values,p+1,stop))
        thr76a4d6c_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thr70a9f84e_0 = Thread(target=bubbleSort, args=(values1,))
thr70a9f84e_0.start()

thr70a9f84e_1 = Thread(target=quickSort, args=(values2,0,elementCount))
thr70a9f84e_1.start()

thr70a9f84e_2 = Thread(target=heapSort, args=(values3,))
thr70a9f84e_2.start()
