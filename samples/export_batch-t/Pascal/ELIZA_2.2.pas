  index25bbf683: 1..5;
  array25bbf683: array [1..5] of string;
  index51c8530f: 1..2;
  array51c8530f: array [1..2] of string;
{
...
begin
  ...
  array51c8530f[1] := " i ";
  array51c8530f[2] := " i\'";
  for index51c8530f := 1 to 2 do
  begin
    word := array51c8530f[index51c8530f];
...
begin
  ...
  array25bbf683[4] := '!';
  array25bbf683[5] := '?';
  for index25bbf683 := 1 to 5 do
  begin
    symbol := array25bbf683[index25bbf683];
