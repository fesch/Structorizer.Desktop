  indexcb51256: 1..5;
  arraycb51256: array [1..5] of string;
  index7ce6a65d: 1..2;
  array7ce6a65d: array [1..2] of string;
  index32d2fa64: 1..2;
  array32d2fa64: array [1..2] of string;
{
...
begin
  ...
  array32d2fa64[1] := " i ";
  array32d2fa64[2] := " i\'";
  for index32d2fa64 := 1 to 2 do
  begin
    word := array32d2fa64[index32d2fa64];
...
function conjugateStrings(sentence: string; key: string; keyPos: Longint; flexions: array of array [0..1] of string): string;
...
begin
  ...
  array7ce6a65d[1] := "  ";
  array7ce6a65d[2] := "|";
  for index7ce6a65d := 1 to 2 do
  begin
    str := array7ce6a65d[index7ce6a65d];
...
function findKeyword(const keyMap: array of KeyMapEntry; sentence: string): array [0..1] of Longint;
...
begin
  ...
  arraycb51256[4] := '!';
  arraycb51256[5] := '?';
  for indexcb51256 := 1 to 5 do
  begin
    symbol := arraycb51256[indexcb51256];
