  index544a2ea6: 1..5;
  array544a2ea6: array [1..5] of string;
  index18bf3d14: 1..2;
  array18bf3d14: array [1..2] of string;
  index43738a82: 1..2;
  array43738a82: array [1..2] of string;
{
...
begin
  ...
  array43738a82[1] := " i ";
  array43738a82[2] := " i\'";
  for index43738a82 := 1 to 2 do
  begin
    word := array43738a82[index43738a82];
...
begin
  ...
  array18bf3d14[1] := "  ";
  array18bf3d14[2] := "|";
  for index18bf3d14 := 1 to 2 do
  begin
    str := array18bf3d14[index18bf3d14];
...
begin
  ...
  array544a2ea6[4] := '!';
  array544a2ea6[5] := '?';
  for index544a2ea6 := 1 to 5 do
  begin
    symbol := array544a2ea6[index544a2ea6];
