...
sub readNumbers {
    ...
    nNumbers <- 0;
    # TODO FileAPI: Replace the fileOpen call by something like «open(my $fHandle, "<", "filename") or die "error message";» 
    ...
    eval {
        ...
        while not fileEOF(fileNo) and nNumbers < maxNumbers {
            # TODO FileAPI: Replace the fileReadInt call by something like «<$fileHandle>";» 
