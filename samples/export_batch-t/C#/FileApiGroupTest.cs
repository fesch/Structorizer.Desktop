...
public class readNumbers
{
	...
	public static void null()
	{
		...
		catch(Exception ex2173f6d9)
		{
			string error = ex2173f6d9.ToString()
			throw;
		}
		finally
		{
...
// 			fileClose(fileNo); 
			...
			catch(Exception ex436e852b)
			{
				string failure = ex436e852b.ToString()
...
public class DrawRandomHistogram
{
	...
	public static void Main(string[] args)
	{
		...
		if (fileNo > 0)
		{
			...
			catch(Exception ex26a7b76d)
			{
				string failure = ex26a7b76d.ToString()
				Console.WriteLine(failure);
			}
			if (nObtained > 0)
			{
