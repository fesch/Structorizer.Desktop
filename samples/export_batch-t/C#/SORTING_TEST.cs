...
public class SORTING_TEST_MAIN {
	...
	class Worker7113b13f_0{
		// TODO: Check and accomplish the member declarations here 
		private int[] values1;
		public Worker7113b13f_0(int[] values1)
		{
	...
	class Worker7113b13f_1{
		// TODO: Check and accomplish the member declarations here 
		private int[] values2;
		private ??? elementCount;
		public Worker7113b13f_1(int[] values2, ??? elementCount)
		{
	...
	class Worker7113b13f_2{
		// TODO: Check and accomplish the member declarations here 
		private int[] values3;
		public Worker7113b13f_2(int[] values3)
		{
	...
	// =========== START PARALLEL WORKER DEFINITIONS ============ 
	class Worker6121c9d6_0{
		// TODO: Check and accomplish the member declarations here 
		private ??? values;
		private ??? start;
		private ??? p;
		public Worker6121c9d6_0(??? values, ??? start, ??? p)
		{
			this.values = values;
			this.start = start;
			this.p = p;
	...
	class Worker6121c9d6_1{
		// TODO: Check and accomplish the member declarations here 
		private ??? values;
		private ??? p;
		private ??? stop;
		public Worker6121c9d6_1(??? values, ??? p, ??? stop)
		{
			this.values = values;
			this.p = p;
			this.stop = stop;
	...
	public static void Main(string[] args) {
		...
		// ========================================================== 
		{
			Worker7113b13f_0 worker7113b13f_0 = new Worker7113b13f_0(values1);
			Thread thr7113b13f_0 = new Thread(worker7113b13f_0.DoWork);
			thr7113b13f_0.Start();
		
			Worker7113b13f_1 worker7113b13f_1 = new Worker7113b13f_1(values2, elementCount);
			Thread thr7113b13f_1 = new Thread(worker7113b13f_1.DoWork);
			thr7113b13f_1.Start();
		
			Worker7113b13f_2 worker7113b13f_2 = new Worker7113b13f_2(values3);
			Thread thr7113b13f_2 = new Thread(worker7113b13f_2.DoWork);
			thr7113b13f_2.Start();
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		...
		if (stop >= start + 2) {
			...
			// ========================================================== 
			{
				Worker6121c9d6_0 worker6121c9d6_0 = new Worker6121c9d6_0(values, start, p);
				Thread thr6121c9d6_0 = new Thread(worker6121c9d6_0.DoWork);
				thr6121c9d6_0.Start();
			
				Worker6121c9d6_1 worker6121c9d6_1 = new Worker6121c9d6_1(values, p, stop);
				Thread thr6121c9d6_1 = new Thread(worker6121c9d6_1.DoWork);
				thr6121c9d6_1.Start();
