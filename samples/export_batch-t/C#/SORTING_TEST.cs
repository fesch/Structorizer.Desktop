...
public class SORTING_TEST_MAIN
{
	...
	class Worker184f6be2_0{
		// TODO: Check and accomplish the member declarations here 
		private int[] values1;
		public Worker184f6be2_0(int[] values1)
		{
	...
	class Worker184f6be2_1{
		// TODO: Check and accomplish the member declarations here 
		private int[] values2;
		private ??? elementCount;
		public Worker184f6be2_1(int[] values2, ??? elementCount)
		{
	...
	class Worker184f6be2_2{
		// TODO: Check and accomplish the member declarations here 
		private int[] values3;
		public Worker184f6be2_2(int[] values3)
		{
	...
	// =========== START PARALLEL WORKER DEFINITIONS ============ 
	class Worker6ee52dcd_0{
		// TODO: Check and accomplish the member declarations here 
		private ??? values;
		private ??? start;
		private ??? p;
		public Worker6ee52dcd_0(??? values, ??? start, ??? p)
		{
			this.values = values;
			this.start = start;
			this.p = p;
	...
	class Worker6ee52dcd_1{
		// TODO: Check and accomplish the member declarations here 
		private ??? values;
		private ??? p;
		private ??? stop;
		public Worker6ee52dcd_1(??? values, ??? p, ??? stop)
		{
			this.values = values;
			this.p = p;
			this.stop = stop;
	...
	public static void Main(string[] args)
	{
		...
		// ========================================================== 
		{
			Worker184f6be2_0 worker184f6be2_0 = new Worker184f6be2_0(values1);
			Thread thr184f6be2_0 = new Thread(worker184f6be2_0.DoWork);
			thr184f6be2_0.Start();
		
			Worker184f6be2_1 worker184f6be2_1 = new Worker184f6be2_1(values2, elementCount);
			Thread thr184f6be2_1 = new Thread(worker184f6be2_1.DoWork);
			thr184f6be2_1.Start();
		
			Worker184f6be2_2 worker184f6be2_2 = new Worker184f6be2_2(values3);
			Thread thr184f6be2_2 = new Thread(worker184f6be2_2.DoWork);
			thr184f6be2_2.Start();
	...
	private static void quickSort(??? values, ??? start, ??? stop)
	{
		...
		if (stop >= start + 2)
		{
			...
			// ========================================================== 
			{
				Worker6ee52dcd_0 worker6ee52dcd_0 = new Worker6ee52dcd_0(values, start, p);
				Thread thr6ee52dcd_0 = new Thread(worker6ee52dcd_0.DoWork);
				thr6ee52dcd_0.Start();
			
				Worker6ee52dcd_1 worker6ee52dcd_1 = new Worker6ee52dcd_1(values, p, stop);
				Thread thr6ee52dcd_1 = new Thread(worker6ee52dcd_1.DoWork);
				thr6ee52dcd_1.Start();
