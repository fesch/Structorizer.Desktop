...
set -A replies "${result51c8530f[@]}"
const reflexions <- setupReflexions()
set -A reflexions "${result7403c468[@]}"
const byePhrases <- setupGoodByePhrases()
set -A byePhrases "${result43738a82[@]}"
const keyMap <- setupKeywords()
set -A keyMap "${resultc81cdd1[@]}"
