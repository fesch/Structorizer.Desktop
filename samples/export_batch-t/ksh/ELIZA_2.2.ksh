...
set -A replies "${result543c6f6d[@]}"
const reflexions <- setupReflexions()
set -A reflexions "${result13eb8acf[@]}"
const byePhrases <- setupGoodByePhrases()
set -A byePhrases "${result51c8530f[@]}"
const keyMap <- setupKeywords()
set -A keyMap "${result7403c468[@]}"
