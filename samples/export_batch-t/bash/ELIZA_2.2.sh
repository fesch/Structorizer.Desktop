...
declare -ar replies=("${result32eebfca[@]}")
const reflexions <- setupReflexions()
declare -ar reflexions=("${result4e718207[@]}")
const byePhrases <- setupGoodByePhrases()
declare -ar byePhrases=("${result1d371b2d[@]}")
const keyMap <- setupKeywords()
declare -ar keyMap=("${result543c6f6d[@]}")
