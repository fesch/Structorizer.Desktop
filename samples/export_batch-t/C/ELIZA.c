...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array2758fe70[2] = {" i ", " i\'"};
		int index2758fe70;
		for (index2758fe70 = 0; index2758fe70 < 2; index2758fe70++) {
			char* word = array2758fe70[index2758fe70];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count49fc609f = ???;
		int index49fc609f;
		for (index49fc609f = 0; index49fc609f < count49fc609f; index49fc609f++) {
			char* pair[] = phrases[index49fc609f];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		...
		for (index3224f60b = 0; index3224f60b < count3224f60b; index3224f60b++) {
			char* pair[] = flexions[index3224f60b];
			left <- "";
			right <- result;
	...
	{
		char* array72b6cbcc[2] = {"  ", "|"};
		int index72b6cbcc;
		for (index72b6cbcc = 0; index72b6cbcc < 2; index72b6cbcc++) {
			char* str = array72b6cbcc[index72b6cbcc];
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array6c49835d[5] = {'.', ',', ';', '!', '?'};
		int index6c49835d;
		for (index6c49835d = 0; index6c49835d < 5; index6c49835d++) {
			char symbol = array6c49835d[index6c49835d];
