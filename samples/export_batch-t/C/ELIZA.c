...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array75881071[2] = {" i ", " i\'"};
		int index75881071;
		for (index75881071 = 0; index75881071 < 2; index75881071++) {
			char* word = array75881071[index75881071];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count17d0685f = ???;
		int index17d0685f;
		for (index17d0685f = 0; index17d0685f < count17d0685f; index17d0685f++) {
			char* pair[] = phrases[index17d0685f];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count7e0e6aa2 = ???;
		int index7e0e6aa2;
		for (index7e0e6aa2 = 0; index7e0e6aa2 < count7e0e6aa2; index7e0e6aa2++) {
			char* pair[] = flexions[index7e0e6aa2];
			left <- "";
			right <- result;
	...
	{
		char* array42607a4f[2] = {"  ", "|"};
		int index42607a4f;
		for (index42607a4f = 0; index42607a4f < 2; index42607a4f++) {
			char* str = array42607a4f[index42607a4f];
...
char* normalizeInput(char* sentence)
{
	...
	sentence <- lowercase(sentence);
	{
		char array150c158[5] = {'.', ',', ';', '!', '?'};
		int index150c158;
		for (index150c158 = 0; index150c158 < 5; index150c158++) {
			char symbol = array150c158[index150c158];
