...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* arraya38d7a3[2] = {" i ", " i\'"};
		int indexa38d7a3;
		for (indexa38d7a3 = 0; indexa38d7a3 < 2; indexa38d7a3++) {
			char* word = arraya38d7a3[indexa38d7a3];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count612fc6eb = ???;
		int index612fc6eb;
		for (index612fc6eb = 0; index612fc6eb < count612fc6eb; index612fc6eb++) {
			char* pair[] = phrases[index612fc6eb];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count612679d6 = ???;
		int index612679d6;
		for (index612679d6 = 0; index612679d6 < count612679d6; index612679d6++) {
			char* pair[] = flexions[index612679d6];
			left <- "";
			right <- result;
	...
	{
		char* array491cc5c9[2] = {"  ", "|"};
		int index491cc5c9;
		for (index491cc5c9 = 0; index491cc5c9 < 2; index491cc5c9++) {
			char* str = array491cc5c9[index491cc5c9];
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array462d5aee[5] = {'.', ',', ';', '!', '?'};
		int index462d5aee;
		for (index462d5aee = 0; index462d5aee < 5; index462d5aee++) {
			char symbol = array462d5aee[index462d5aee];
