...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array9a7504c[2] = {" i ", " i\'"};
		int index9a7504c;
		for (index9a7504c = 0; index9a7504c < 2; index9a7504c++)
		{
			char* word = array9a7504c[index9a7504c];
...
bool checkGoodBye(char* text, char* phrases[][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count6b57696f = ???;
		int index6b57696f;
		for (index6b57696f = 0; index6b57696f < count6b57696f; index6b57696f++)
		{
			char* pair[] = phrases[index6b57696f];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count26a7b76d = ???;
		int index26a7b76d;
		for (index26a7b76d = 0; index26a7b76d < count26a7b76d; index26a7b76d++)
		{
			char* pair[] = flexions[index26a7b76d];
			left <- "";
			right <- result;
	...
	// Eliminate multiple spaces (replaced by single ones) and vertical bars 
	{
		char* arraye874448[2] = {"  ", "|"};
		int indexe874448;
		for (indexe874448 = 0; indexe874448 < 2; indexe874448++)
		{
			char* str = arraye874448[indexe874448];
...
int[2] findKeyword(const struct KeyMapEntry keyMap[], char* sentence)
{
	// TODO: Check and accomplish variable declarations: 
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array5bfbf16f[5] = {'.', ',', ';', '!', '?'};
		int index5bfbf16f;
		for (index5bfbf16f = 0; index5bfbf16f < 5; index5bfbf16f++)
		{
			char symbol = array5bfbf16f[index5bfbf16f];
...
// TODO: Revise the return type and declare the parameters. 
//       C does not permit to return arrays - find an other way to pass the result! 
struct KeyMapEntry[] setupKeywords(void)
{
	// TODO: Check and accomplish variable declarations: 
