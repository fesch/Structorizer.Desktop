...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array77ec78b9[2] = {" i ", " i\'"};
		int index77ec78b9;
		for (index77ec78b9 = 0; index77ec78b9 < 2; index77ec78b9++) {
			char* word = array77ec78b9[index77ec78b9];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count4eb7f003 = ???;
		int index4eb7f003;
		for (index4eb7f003 = 0; index4eb7f003 < count4eb7f003; index4eb7f003++) {
			char* pair[] = phrases[index4eb7f003];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		...
		for (index491cc5c9 = 0; index491cc5c9 < count491cc5c9; index491cc5c9++) {
			char* pair[] = flexions[index491cc5c9];
			left <- "";
			right <- result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array757942a1[5] = {'.', ',', ';', '!', '?'};
		int index757942a1;
		for (index757942a1 = 0; index757942a1 < 5; index757942a1++) {
			char symbol = array757942a1[index757942a1];
