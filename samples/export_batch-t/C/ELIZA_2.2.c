...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* arrayc81cdd1[2] = {" i ", " i\'"};
		int indexc81cdd1;
		for (indexc81cdd1 = 0; indexc81cdd1 < 2; indexc81cdd1++) {
			char* word = arrayc81cdd1[indexc81cdd1];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count289d1c02 = ???;
		int index289d1c02;
		for (index289d1c02 = 0; index289d1c02 < count289d1c02; index289d1c02++) {
			char* pair[] = phrases[index289d1c02];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count12c8a2c0 = ???;
		int index12c8a2c0;
		for (index12c8a2c0 = 0; index12c8a2c0 < count12c8a2c0; index12c8a2c0++) {
			char* pair[] = flexions[index12c8a2c0];
			left <- "";
			right <- result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array7276c8cd[5] = {'.', ',', ';', '!', '?'};
		int index7276c8cd;
		for (index7276c8cd = 0; index7276c8cd < 5; index7276c8cd++) {
			char symbol = array7276c8cd[index7276c8cd];
