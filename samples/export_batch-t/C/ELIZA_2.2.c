...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array627551fb[2] = {" i ", " i\'"};
		int index627551fb;
		for (index627551fb = 0; index627551fb < 2; index627551fb++) {
			char* word = array627551fb[index627551fb];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count32709393 = ???;
		int index32709393;
		for (index32709393 = 0; index32709393 < count32709393; index32709393++) {
			char* pair[] = phrases[index32709393];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count3b084709 = ???;
		int index3b084709;
		for (index3b084709 = 0; index3b084709 < count3b084709; index3b084709++) {
			char* pair[] = flexions[index3b084709];
			left <- "";
			right <- result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array7c29daf3[5] = {'.', ',', ';', '!', '?'};
		int index7c29daf3;
		for (index7c29daf3 = 0; index7c29daf3 < 5; index7c29daf3++) {
			char symbol = array7c29daf3[index7c29daf3];
