...
var
  index2e3fc542: 1..5;
  array2e3fc542: array [1..5] of string;
  index4fb64261: 1..2;
  array4fb64261: array [1..2] of string;
  indexc81cdd1: 1..2;
  arrayc81cdd1: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arrayc81cdd1[1] := ' i ';
  arrayc81cdd1[2] := ' i\''';
  for indexc81cdd1 := 1 to 2 do
  begin
    word := arrayc81cdd1[indexc81cdd1];
...
begin
  ...
  array4fb64261[1] := ' ';
  array4fb64261[2] := '|';
  for index4fb64261 := 1 to 2 do
  begin
    str := array4fb64261[index4fb64261];
...
begin
  ...
  array2e3fc542[4] := '!';
  array2e3fc542[5] := '?';
  for index2e3fc542 := 1 to 5 do
  begin
    symbol := array2e3fc542[index2e3fc542];
