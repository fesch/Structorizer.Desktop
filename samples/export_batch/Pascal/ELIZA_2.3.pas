...
var
  index83c69ae6: 1..5;
  array83c69ae6: array [1..5] of string;
  indexa43129f5: 1..2;
  arraya43129f5: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arraya43129f5[1] := ' i ';
  arraya43129f5[2] := ' i\''';
  for indexa43129f5 := 1 to 2 do
  begin
    word := arraya43129f5[indexa43129f5];
...
begin
  ...
  array83c69ae6[4] := '!';
  array83c69ae6[5] := '?';
  for index83c69ae6 := 1 to 5 do
  begin
    symbol := array83c69ae6[index83c69ae6];
