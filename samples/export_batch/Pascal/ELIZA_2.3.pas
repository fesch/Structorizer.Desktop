...
var
  indexa816bc6a: 1..5;
  arraya816bc6a: array [1..5] of string;
  indexd15714c9: 1..2;
  arrayd15714c9: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arrayd15714c9[1] := ' i ';
  arrayd15714c9[2] := ' i\''';
  for indexd15714c9 := 1 to 2 do
  begin
    word := arrayd15714c9[indexd15714c9];
...
begin
  ...
  arraya816bc6a[4] := '!';
  arraya816bc6a[5] := '?';
  for indexa816bc6a := 1 to 5 do
  begin
    symbol := arraya816bc6a[indexa816bc6a];
