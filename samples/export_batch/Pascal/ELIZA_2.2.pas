...
var
  index6ec8211c: 1..5;
  array6ec8211c: array [1..5] of string;
  index7403c468: 1..2;
  array7403c468: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  array7403c468[1] := ' i ';
  array7403c468[2] := ' i\''';
  for index7403c468 := 1 to 2 do
  begin
    word := array7403c468[index7403c468];
...
begin
  ...
  array6ec8211c[4] := '!';
  array6ec8211c[5] := '?';
  for index6ec8211c := 1 to 5 do
  begin
    symbol := array6ec8211c[index6ec8211c];
