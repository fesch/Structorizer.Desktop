...
var
  indexb50db516: 1..5;
  arrayb50db516: array [1..5] of string;
  indexd8d83d9: 1..2;
  arrayd8d83d9: array [1..2] of string;
  varPart: String;
  {
...
begin
  ...
  arrayd8d83d9[1] := ' i ';
  arrayd8d83d9[2] := ' i\''';
  for indexd8d83d9 := 1 to 2 do
  begin
    word := arrayd8d83d9[indexd8d83d9];
...
begin
  ...
  arrayb50db516[4] := '!';
  arrayb50db516[5] := '?';
  for indexb50db516 := 1 to 5 do
  begin
    symbol := arrayb50db516[indexb50db516];
