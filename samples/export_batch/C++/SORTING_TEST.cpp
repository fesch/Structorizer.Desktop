...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc37374a5e_0 thrfunc37374a5e_0;
			std::thread thr37374a5e_0(thrfunc37374a5e_0, values, start, p);
		
			ThrFunc37374a5e_1 thrfunc37374a5e_1;
			std::thread thr37374a5e_1(thrfunc37374a5e_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFunc6f195bc3_0 thrfunc6f195bc3_0;
		std::thread thr6f195bc3_0(thrfunc6f195bc3_0, values1);
	
		ThrFunc6f195bc3_1 thrfunc6f195bc3_1;
		std::thread thr6f195bc3_1(thrfunc6f195bc3_1, values2, elementCount);
	
		ThrFunc6f195bc3_2 thrfunc6f195bc3_2;
		std::thread thr6f195bc3_2(thrfunc6f195bc3_2, values3);
