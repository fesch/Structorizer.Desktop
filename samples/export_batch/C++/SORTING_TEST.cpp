...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFuncf0145963_0 thrfuncf0145963_0;
			std::thread thrf0145963_0(thrfuncf0145963_0, values, start, p);
		
			ThrFuncf0145963_1 thrfuncf0145963_1;
			std::thread thrf0145963_1(thrfuncf0145963_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFuncf28cce30_0 thrfuncf28cce30_0;
		std::thread thrf28cce30_0(thrfuncf28cce30_0, values1);
	
		ThrFuncf28cce30_1 thrfuncf28cce30_1;
		std::thread thrf28cce30_1(thrfuncf28cce30_1, values2, elementCount);
	
		ThrFuncf28cce30_2 thrfuncf28cce30_2;
		std::thread thrf28cce30_2(thrfuncf28cce30_2, values3);
