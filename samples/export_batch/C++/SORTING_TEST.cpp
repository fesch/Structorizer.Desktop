...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc77d240a9_0 thrfunc77d240a9_0;
			std::thread thr77d240a9_0(thrfunc77d240a9_0, values, start, p);
		
			ThrFunc77d240a9_1 thrfunc77d240a9_1;
			std::thread thr77d240a9_1(thrfunc77d240a9_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFuncbebbea37_0 thrfuncbebbea37_0;
		std::thread thrbebbea37_0(thrfuncbebbea37_0, values1);
	
		ThrFuncbebbea37_1 thrfuncbebbea37_1;
		std::thread thrbebbea37_1(thrfuncbebbea37_1, values2, elementCount);
	
		ThrFuncbebbea37_2 thrfuncbebbea37_2;
		std::thread thrbebbea37_2(thrfuncbebbea37_2, values3);
