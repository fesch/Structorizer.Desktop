...
void quickSort(??? values, ??? start, ??? stop)
{
	...
	if (stop >= start + 2) {
		...
		// Parallel section 
		{
			ThrFunc162ae8ae_0 thrfunc162ae8ae_0;
			std::thread thr162ae8ae_0(thrfunc162ae8ae_0, values, start, p);
		
			ThrFunc162ae8ae_1 thrfunc162ae8ae_1;
			std::thread thr162ae8ae_1(thrfunc162ae8ae_1, values, p, stop);
...
int main(void)
{
	...
	// Parallel section 
	{
		ThrFunc86ef2ff7_0 thrfunc86ef2ff7_0;
		std::thread thr86ef2ff7_0(thrfunc86ef2ff7_0, values1);
	
		ThrFunc86ef2ff7_1 thrfunc86ef2ff7_1;
		std::thread thr86ef2ff7_1(thrfunc86ef2ff7_1, values2, elementCount);
	
		ThrFunc86ef2ff7_2 thrfunc86ef2ff7_2;
		std::thread thr86ef2ff7_2(thrfunc86ef2ff7_2, values3);
