...
Rem Generated by Structorizer 3.32-10 
...
Function adjustSpelling(sentence As String) As String
  ...
  End If
  Dim array32463983() As String = {" i ", " i\'"}
  For Each word In array32463983
...
Function conjugateStrings(sentence As String, key As String, keyPos As integer, flexions As String(50,0 To 1)) As String
  ...
  Dim array26db57f() As String = {"  ", "|"}
  For Each str In array26db57f
...
Function normalizeInput(sentence As String) As String
  ...
  Dim arraye4fb859a() As FIXME_e4fb859a = {'.', ',', ';', '!', '?'}
  For Each symbol In arraye4fb859a
