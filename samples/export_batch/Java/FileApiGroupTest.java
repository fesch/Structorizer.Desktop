...
public class readNumbers {
	...
	public static int readNumbers(String fileName, int[] numbers, int maxNumbers) {
		...
		catch (Exception ex4abdb505) {
			String error = ex4abdb505.getMessage()
			throw ex4abdb505;
		}
		finally {
...
// 			fileClose(fileNo); 
			...
			catch (Exception ex1e7c7811) {
				String failure = ex1e7c7811.getMessage()
...
public class DrawRandomHistogram {
	...
	public static void main(String[] args) {
		...
		if (fileNo > 0) {
			...
			catch (Exception ex1060b431) {
				String failure = ex1060b431.getMessage()
				System.out.println(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
