...
public class readNumbers {
	...
	public static int readNumbers(String fileName, int[] numbers, int maxNumbers) {
		...
		catch (Exception exfc03966c) {
			String error = exfc03966c.getMessage()
			throw exfc03966c;
		}
		finally {
...
// 			fileClose(fileNo); 
			...
			catch (Exception exb908fdd0) {
				String failure = exb908fdd0.getMessage()
...
public class DrawRandomHistogram {
	...
	public static void main(String[] args) {
		...
		if (fileNo > 0) {
			...
			catch (Exception exe22b869f) {
				String failure = exe22b869f.getMessage()
				System.out.println(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
