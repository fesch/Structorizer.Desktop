...
public class readNumbers {
	...
	public static int readNumbers(String fileName, int[] numbers, int maxNumbers) {
		...
		catch (Exception ex1442d7b5) {
			String error = ex1442d7b5.getMessage()
			throw ex1442d7b5;
		}
		finally {
...
// 			fileClose(fileNo); 
			...
			catch (Exception ex70beb599) {
				String failure = ex70beb599.getMessage()
...
public class DrawRandomHistogram {
	...
	public static void main(String[] args) {
		...
		if (fileNo > 0) {
			...
			catch (Exception ex11e21d0e) {
				String failure = ex11e21d0e.getMessage()
				System.out.println(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
