...
public class readNumbers {
	...
	public static int readNumbers(String fileName, int[] numbers, int maxNumbers) {
		...
		catch (Exception ex2c08bf6b) {
			String error = ex2c08bf6b.getMessage()
			throw ex2c08bf6b;
		}
		finally {
...
// 			fileClose(fileNo); 
			...
			catch (Exception exf3169f46) {
				String failure = exf3169f46.getMessage()
...
public class DrawRandomHistogram {
	...
	public static void main(String[] args) {
		...
		if (fileNo > 0) {
			...
			catch (Exception ex404bdfe4) {
				String failure = ex404bdfe4.getMessage()
				System.out.println(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
