...
function setupGoodByePhrases() {
    ...
    declare -a -g result2b552920=("${phrases[@]}")
}
...
function setupReflexions() {
    ...
    declare -a -g result627551fb=("${reflexions[@]}")
}
...
function setupReplies() {
    ...
    declare -a -g result3701eaf6=("${setupReplies[@]}")
}
...
function findKeyword() {
    ...
    declare -a -g result35d176f7=("${result[@]}")
}
...
function setupKeywords() {
    ...
    declare -a -g result2758fe70=("${keywords[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${result3701eaf6[@]}")
setupReflexions
declare -ar reflexions=("${result627551fb[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result2b552920[@]}")
setupKeywords
declare -ar keyMap=("${result2758fe70[@]}")
