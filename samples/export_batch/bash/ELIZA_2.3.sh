...
function findKeyword() {
 ...
 declare -a -g result8f93a883=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g resultf650e713=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resultf446fd19=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result5b46d882=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resultbc2c085d=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${resultbc2c085d[@]}")
setupReflexions
declare -ar reflexions=("${result5b46d882[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${resultf650e713[@]}")
setupKeywords
declare -ar keyMap=("${resultf446fd19[@]}")
