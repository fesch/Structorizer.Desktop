...
function findKeyword() {
 ...
 declare -a -g resultd4f332d2=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result1248afb8=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result882f0573=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result7de173fe=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result792ab274=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${result792ab274[@]}")
setupReflexions
declare -ar reflexions=("${result7de173fe[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result1248afb8[@]}")
setupKeywords
declare -ar keyMap=("${result882f0573[@]}")
