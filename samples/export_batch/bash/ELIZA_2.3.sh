...
function findKeyword() {
 ...
 declare -a -g result2a70a3d8=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result7403c468=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result43738a82=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result51c8530f=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result13eb8acf=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${result13eb8acf[@]}")
setupReflexions
declare -ar reflexions=("${result51c8530f[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result7403c468[@]}")
setupKeywords
declare -ar keyMap=("${result43738a82[@]}")
