...
function findKeyword() {
    ...
    declare -a -g result4e718207=("${result[@]}")
}
...
function setupGoodByePhrases() {
    ...
    declare -a -g result8e24743=("${phrases[@]}")
}
...
function setupKeywords() {
    ...
    declare -a -g result74a10858=("${keywords[@]}")
}
...
function setupReflexions() {
    ...
    declare -a -g resultcb0ed20=("${reflexions[@]}")
}
...
function setupReplies() {
    ...
    declare -a -g result5891e32e=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${result5891e32e[@]}")
setupReflexions
declare -ar reflexions=("${resultcb0ed20[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result8e24743[@]}")
setupKeywords
declare -ar keyMap=("${result74a10858[@]}")
