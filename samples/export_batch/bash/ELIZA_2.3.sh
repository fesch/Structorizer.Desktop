...
function findKeyword() {
 ...
 declare -a -g result524c61a2=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result8074e13b=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resultccf582e5=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result4c7afff4=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result358b0051=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${result358b0051[@]}")
setupReflexions
declare -ar reflexions=("${result4c7afff4[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result8074e13b[@]}")
setupKeywords
declare -ar keyMap=("${resultccf582e5[@]}")
