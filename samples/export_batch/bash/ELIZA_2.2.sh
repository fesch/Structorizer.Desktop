...
function findKeyword() {
    ...
    declare -a -g result28ac3dc3=("${result[@]}")
}
...
function setupGoodByePhrases() {
    ...
    declare -a -g result5891e32e=("${phrases[@]}")
}
...
function setupKeywords() {
    ...
    declare -a -g resultcb0ed20=("${keywords[@]}")
}
...
function setupReflexions() {
    ...
    declare -a -g result7a30d1e6=("${reflexions[@]}")
}
...
function setupReplies() {
    ...
    declare -a -g result553a3d88=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${result553a3d88[@]}")
setupReflexions
declare -ar reflexions=("${result7a30d1e6[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result5891e32e[@]}")
setupKeywords
declare -ar keyMap=("${resultcb0ed20[@]}")
