...
function findKeyword() {
 ...
 declare -a -g result89707398=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g resultd126d769=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result70a22f45=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g resultcbd01fe4=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resultb2a4fd1c=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${resultb2a4fd1c[@]}")
setupReflexions
declare -ar reflexions=("${resultcbd01fe4[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${resultd126d769[@]}")
setupKeywords
declare -ar keyMap=("${result70a22f45[@]}")
