...
function setupGoodByePhrases() {
    ...
    declare -a -g result3701eaf6=("${phrases[@]}")
}
...
function setupReflexions() {
    ...
    declare -a -g result5c5a1b69=("${reflexions[@]}")
}
...
function setupReplies() {
    ...
    declare -a -g result43814d18=("${setupReplies[@]}")
}
...
function findKeyword() {
    ...
    declare -a -g result578486a3=("${result[@]}")
}
...
function setupKeywords() {
    ...
    declare -a -g result627551fb=("${keywords[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${result43814d18[@]}")
setupReflexions
declare -ar reflexions=("${result5c5a1b69[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result3701eaf6[@]}")
setupKeywords
declare -ar keyMap=("${result627551fb[@]}")
