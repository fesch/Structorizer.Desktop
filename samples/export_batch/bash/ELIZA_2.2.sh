...
function findKeyword() {
 ...
 declare -a -g result1fc2b765=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result13eb8acf=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result51c8530f=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result543c6f6d=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result1d371b2d=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${result1d371b2d[@]}")
setupReflexions
declare -ar reflexions=("${result543c6f6d[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result13eb8acf[@]}")
setupKeywords
declare -ar keyMap=("${result51c8530f[@]}")
