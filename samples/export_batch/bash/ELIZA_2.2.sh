...
function findKeyword() {
 ...
 declare -a -g resultfc3b9fea=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g resulte32d203c=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g resultd406e6a4=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result47ead982=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result327357a4=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${result327357a4[@]}")
setupReflexions
declare -ar reflexions=("${result47ead982[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${resulte32d203c[@]}")
setupKeywords
declare -ar keyMap=("${resultd406e6a4[@]}")
