...
function checkGoodBye() {
 ...
 do
  ...
  then
   saidBye=1
   echo local dummy307f6b8c=${pair[1]}
   result631330c=1
   return 0
  fi
...
function findKeyword() {
 ...
 declare -a -g resultc46bcd4=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result51e2adc7=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result1a8a8f7c=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result6f195bc3=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result7a187f14=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${result7a187f14[@]}")
setupReflexions
declare -ar reflexions=("${result6f195bc3[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result51e2adc7[@]}")
setupKeywords
declare -ar keyMap=("${result1a8a8f7c[@]}")
