...
function findKeyword() {
 ...
 declare -a -g resulte5295f07=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result42c67a4f=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result87bf670f=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g resultb35ea093=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g resultecb81a1b=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
declare -a history=(0 "" "" "" "" "")
setupReplies
declare -ar replies=("${resultecb81a1b[@]}")
setupReflexions
declare -ar reflexions=("${resultb35ea093[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result42c67a4f[@]}")
setupKeywords
declare -ar keyMap=("${result87bf670f[@]}")
