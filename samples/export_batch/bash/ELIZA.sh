...
function checkGoodBye() {
 ...
 do
  ...
  then
   echo local dummy6f195bc3=${pair[1]}
   resultc46bcd4=1
   return 0
  fi
...
function findKeyword() {
 ...
 declare -a -g result3d921e20=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result2353b3e6=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result631330c=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result1a8a8f7c=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result51e2adc7=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${result51e2adc7[@]}")
setupReflexions
declare -ar reflexions=("${result1a8a8f7c[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result2353b3e6[@]}")
setupKeywords
declare -ar keyMap=("${result631330c[@]}")
