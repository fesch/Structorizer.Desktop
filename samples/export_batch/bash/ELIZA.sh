...
function findKeyword() {
 ...
 declare -a -g resultd121d270=("${result[@]}")
}
...
function setupGoodByePhrases() {
 ...
 declare -a -g result2172682=("${phrases[@]}")
}
...
function setupKeywords() {
 ...
 declare -a -g result7e1729da=("${keywords[@]}")
}
...
function setupReflexions() {
 ...
 declare -a -g result48999612=("${reflexions[@]}")
}
...
function setupReplies() {
 ...
 declare -a -g result94d5d18f=("${setupReplies[@]}")
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
declare -ar replies=("${result94d5d18f[@]}")
setupReflexions
declare -ar reflexions=("${result48999612[@]}")
setupGoodByePhrases
declare -ar byePhrases=("${result2172682[@]}")
setupKeywords
declare -ar keyMap=("${result7e1729da[@]}")
