...
function readNumbers() {
    ...
    trap3d921e20=$( trap -p EXIT )
    if [ -z "$trap3d921e20" ] ; then trap3d921e20="-"; else trap3d921e20=${trap3d921e20:8}; trap3d921e20=${trap3d921e20% *}; fi
    if [ "${trap3d921e20:0:1}" = "'" ] ; then trap3d921e20=${trap3d921e20:1} ; trap3d921e20=${trap3d921e20%\'*}; fi
    trap "finally3d921e20 trapped" EXIT
    { # try
    ...
    trap "${trap3d921e20}" EXIT
    { # finally
        finally3d921e20 okay
    }
    result1f57539=${nNumbers}
}
