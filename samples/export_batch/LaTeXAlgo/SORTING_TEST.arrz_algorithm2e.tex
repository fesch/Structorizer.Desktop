...
\begin{procedure}
\caption{maxHeapify(heap,\textbackslash{}\ i,\textbackslash{}\ range)}
...
\begin{function}
\caption{partition(values,\textbackslash{}\ start,\textbackslash{}\ stop,\textbackslash{}\ p)}
...
\begin{procedure}
\caption{quickSort(values,\textbackslash{}\ start,\textbackslash{}\ stop)}
