...
\PROCEDURE{drawBarChart}{values, nValues}
  ...
  \BEGIN
    ...
    discr436e852b <- k mod 3\\
    \IF discr436e852b=0 \THEN
      setPenColor(255,0,0)\\
    \ELSEIF discr436e852b=1 \THEN
      setPenColor(0,255,0)\\
    \ELSEIF discr436e852b=2 \THEN
      setPenColor(0,0,255)\\
    fd(1)\\
    left(90)\\
    penDown()\\
...
\COMMENT{ Reads a random number file and draws a histogram according to the }\\
