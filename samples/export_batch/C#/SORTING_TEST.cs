...
public class SORTING_TEST_MAIN {
	...
	class Worker4aa74a44_0{
		// TODO: Check and accomplish the member declarations here 
		private int[] values1;
		public Worker4aa74a44_0(int[] values1)
		{
	...
	class Worker4aa74a44_1{
		// TODO: Check and accomplish the member declarations here 
		private ???[] values2;
		private ??? elementCount;
		public Worker4aa74a44_1(???[] values2, ??? elementCount)
		{
	...
	class Worker4aa74a44_2{
		// TODO: Check and accomplish the member declarations here 
		private ???[] values3;
		public Worker4aa74a44_2(???[] values3)
		{
	...
	// =========== START PARALLEL WORKER DEFINITIONS ============ 
	class Worker29d114ff_0{
		// TODO: Check and accomplish the member declarations here 
		private ??? values;
		private ??? start;
		private ??? p;
		public Worker29d114ff_0(??? values, ??? start, ??? p)
		{
			this.values = values;
			this.start = start;
			this.p = p;
	...
	class Worker29d114ff_1{
		// TODO: Check and accomplish the member declarations here 
		private ??? values;
		private ??? p;
		private ??? stop;
		public Worker29d114ff_1(??? values, ??? p, ??? stop)
		{
			this.values = values;
			this.p = p;
			this.stop = stop;
	...
	public static void Main(string[] args) {
		...
		// ========================================================== 
		{
			Worker4aa74a44_0 worker4aa74a44_0 = new Worker4aa74a44_0(values1);
			Thread thr4aa74a44_0 = new Thread(worker4aa74a44_0.DoWork);
			thr4aa74a44_0.Start();
		
			Worker4aa74a44_1 worker4aa74a44_1 = new Worker4aa74a44_1(values2, elementCount);
			Thread thr4aa74a44_1 = new Thread(worker4aa74a44_1.DoWork);
			thr4aa74a44_1.Start();
		
			Worker4aa74a44_2 worker4aa74a44_2 = new Worker4aa74a44_2(values3);
			Thread thr4aa74a44_2 = new Thread(worker4aa74a44_2.DoWork);
			thr4aa74a44_2.Start();
	...
	private static void quickSort(??? values, ??? start, ??? stop) {
		...
		if (stop >= start + 2) {
			...
			// ========================================================== 
			{
				Worker29d114ff_0 worker29d114ff_0 = new Worker29d114ff_0(values, start, p);
				Thread thr29d114ff_0 = new Thread(worker29d114ff_0.DoWork);
				thr29d114ff_0.Start();
			
				Worker29d114ff_1 worker29d114ff_1 = new Worker29d114ff_1(values, p, stop);
				Thread thr29d114ff_1 = new Thread(worker29d114ff_1.DoWork);
				thr29d114ff_1.Start();
