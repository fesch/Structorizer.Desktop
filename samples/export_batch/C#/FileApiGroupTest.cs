...
public class readNumbers {
	...
	public static void null() {
		...
		catch(Exception exb70afdae) {
			string error = exb70afdae.ToString()
			throw;
		}
		finally {
...
// 			StructorizerFileAPI.fileClose(fileNo); 
			...
			catch(Exception exad7ce478) {
				string failure = exad7ce478.ToString()
...
public class DrawRandomHistogram {
	...
	public static void Main(string[] args) {
		...
		if (fileNo > 0) {
			...
			catch(Exception exde2b138e) {
				string failure = exde2b138e.ToString()
				Console.WriteLine(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
