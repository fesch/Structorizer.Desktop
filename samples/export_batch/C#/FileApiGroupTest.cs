...
public class readNumbers {
	...
	public static void null() {
		...
		catch(Exception exa73f67a3) {
			string error = exa73f67a3.ToString()
			throw;
		}
		finally {
...
// 			StructorizerFileAPI.fileClose(fileNo); 
			...
			catch(Exception ex75185fa) {
				string failure = ex75185fa.ToString()
...
public class DrawRandomHistogram {
	...
	public static void Main(string[] args) {
		...
		if (fileNo > 0) {
			...
			catch(Exception exfcbb7cdd) {
				string failure = exfcbb7cdd.ToString()
				Console.WriteLine(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
