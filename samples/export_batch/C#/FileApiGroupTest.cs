...
public class readNumbers {
	...
	public static void null() {
		...
		catch(Exception exbe6a171) {
			string error = exbe6a171.ToString()
			throw;
		}
		finally {
...
// 			StructorizerFileAPI.fileClose(fileNo); 
			...
			catch(Exception ex1be58cac) {
				string failure = ex1be58cac.ToString()
...
public class DrawRandomHistogram {
	...
	public static void Main(string[] args) {
		...
		if (fileNo > 0) {
			...
			catch(Exception ex8041b2aa) {
				string failure = ex8041b2aa.ToString()
				Console.WriteLine(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
