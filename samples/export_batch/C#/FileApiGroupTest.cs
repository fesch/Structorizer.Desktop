...
public class readNumbers {
	...
	public static void null() {
		...
		catch(Exception ex1302e873) {
			string error = ex1302e873.ToString()
			throw;
		}
		finally {
...
// 			StructorizerFileAPI.fileClose(fileNo); 
			...
			catch(Exception ex433cf52f) {
				string failure = ex433cf52f.ToString()
...
public class DrawRandomHistogram {
	...
	public static void Main(string[] args) {
		...
		if (fileNo > 0) {
			...
			catch(Exception ex32ed47a7) {
				string failure = ex32ed47a7.ToString()
				Console.WriteLine(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
