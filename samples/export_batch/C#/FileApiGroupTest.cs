...
public class readNumbers {
	...
	public static void null() {
		...
		try {
			...
			string error = ex1060b431.ToString()
			throw;
		}
		finally {
...
// 			StructorizerFileAPI.fileClose(fileNo); 
			...
			catch(Exception ex52f759d7) {
				string failure = ex52f759d7.ToString()
...
public class DrawRandomHistogram {
	...
	public static void Main(string[] args) {
		...
		if (fileNo > 0) {
			...
			catch(Exception ex28ac3dc3) {
				string failure = ex28ac3dc3.ToString()
				Console.WriteLine(failure);
			}
			if (nObtained > 0) {
				??? min = numberArray[0];
