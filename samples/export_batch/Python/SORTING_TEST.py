...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        threca3a038_0 = Thread(target=quickSort, args=(values,start,p))
        threca3a038_0.start()
        
        threca3a038_1 = Thread(target=quickSort, args=(values,p+1,stop))
        threca3a038_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thrcb815534_0 = Thread(target=bubbleSort, args=(values1,))
thrcb815534_0.start()

thrcb815534_1 = Thread(target=quickSort, args=(values2,0,elementCount))
thrcb815534_1.start()

thrcb815534_2 = Thread(target=heapSort, args=(values3,))
thrcb815534_2.start()
