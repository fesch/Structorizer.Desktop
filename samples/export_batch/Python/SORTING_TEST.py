...
def quickSort(values, start, stop) :
    ...
    if (stop >= start + 2):
        ...
        # ========================================================== 
        thr22228b4a_0 = Thread(target=quickSort, args=(values,start,p))
        thr22228b4a_0.start()
        
        thr22228b4a_1 = Thread(target=quickSort, args=(values,p+1,stop))
        thr22228b4a_1.start()
...
# ================= START PARALLEL SECTION ================= 
# ========================================================== 
thr7004d208_0 = Thread(target=bubbleSort, args=(values1,))
thr7004d208_0.start()

thr7004d208_1 = Thread(target=quickSort, args=(values2,0,elementCount))
thr7004d208_1.start()

thr7004d208_2 = Thread(target=heapSort, args=(values3,))
thr7004d208_2.start()
