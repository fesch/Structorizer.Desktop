...
def drawBarChart(values, nValues) :
    ...
    col19080492 = turtle.pencolor(); turtle.pencolor("#000000")
    ...
    for k in range(0, nValues-1+1, 1):
        ...
        col3220e03e = turtle.pencolor(); turtle.pencolor("#000000")
        turtle.fd(1)
        turtle.left(90)
        turtle.pendown()
