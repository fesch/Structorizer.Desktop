...
def drawBarChart(values, nValues) :
    ...
    col3b123891 = turtle.pencolor(); turtle.pencolor("#000000")
    ...
    for k in range(0, nValues-1+1, 1):
        ...
        col5ec3d89c = turtle.pencolor(); turtle.pencolor("#000000")
        turtle.fd(1)
        turtle.left(90)
        turtle.pendown()
