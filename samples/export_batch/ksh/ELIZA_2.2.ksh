...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result42835c25 "${result[@]}"; export result42835c25
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result7a4f724e "${phrases[@]}"; export result7a4f724e
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result1e0037e8 "${keywords[@]}"; export result1e0037e8
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resulta4f71320 "${reflexions[@]}"; export resulta4f71320
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultc6d41c9f "${setupReplies[@]}"; export resultc6d41c9f
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
set -A history 0 "" "" "" "" ""
setupReplies
set -A replies "${resultc6d41c9f[@]}"
setupReflexions
set -A reflexions "${resulta4f71320[@]}"
setupGoodByePhrases
set -A byePhrases "${result7a4f724e[@]}"
setupKeywords
set -A keyMap "${result1e0037e8[@]}"
