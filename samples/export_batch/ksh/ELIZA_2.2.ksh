...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result802be199 "${result[@]}"; export result802be199
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result25cc5d50 "${phrases[@]}"; export result25cc5d50
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result66c35a4e "${keywords[@]}"; export result66c35a4e
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result410b64c2 "${reflexions[@]}"; export result410b64c2
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultfc24b939 "${setupReplies[@]}"; export resultfc24b939
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
set -A history 0 "" "" "" "" ""
setupReplies
set -A replies "${resultfc24b939[@]}"
setupReflexions
set -A reflexions "${result410b64c2[@]}"
setupGoodByePhrases
set -A byePhrases "${result25cc5d50[@]}"
setupKeywords
set -A keyMap "${result66c35a4e[@]}"
