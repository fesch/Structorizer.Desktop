...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result2758fe70 "${phrases[@]}"; export result2758fe70
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result2b552920 "${reflexions[@]}"; export result2b552920
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result627551fb "${setupReplies[@]}"; export result627551fb
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result1dfe2924 "${result[@]}"; export result1dfe2924
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result1f36e637 "${keywords[@]}"; export result1f36e637
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
set -A history 0 "" "" "" "" ""
setupReplies
set -A replies "${result627551fb[@]}"
setupReflexions
set -A reflexions "${result2b552920[@]}"
setupGoodByePhrases
set -A byePhrases "${result2758fe70[@]}"
setupKeywords
set -A keyMap "${result1f36e637[@]}"
