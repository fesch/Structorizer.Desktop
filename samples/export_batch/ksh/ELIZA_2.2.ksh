...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result22eeefeb "${result[@]}"; export result22eeefeb
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultc81cdd1 "${phrases[@]}"; export resultc81cdd1
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result1fc2b765 "${keywords[@]}"; export result1fc2b765
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result43738a82 "${reflexions[@]}"; export result43738a82
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result7403c468 "${setupReplies[@]}"; export result7403c468
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
set -A history 0 "" "" "" "" ""
setupReplies
set -A replies "${result7403c468[@]}"
setupReflexions
set -A reflexions "${result43738a82[@]}"
setupGoodByePhrases
set -A byePhrases "${resultc81cdd1[@]}"
setupKeywords
set -A keyMap "${result1fc2b765[@]}"
