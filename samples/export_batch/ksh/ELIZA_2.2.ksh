...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result1d371b2d "${result[@]}"; export result1d371b2d
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result74a10858 "${phrases[@]}"; export result74a10858
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result23fe1d71 "${keywords[@]}"; export result23fe1d71
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result8e24743 "${reflexions[@]}"; export result8e24743
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A resultcb0ed20 "${setupReplies[@]}"; export resultcb0ed20
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
set -A history 0 "" "" "" "" ""
setupReplies
set -A replies "${resultcb0ed20[@]}"
setupReflexions
set -A reflexions "${result8e24743[@]}"
setupGoodByePhrases
set -A byePhrases "${result74a10858[@]}"
setupKeywords
set -A keyMap "${result23fe1d71[@]}"
