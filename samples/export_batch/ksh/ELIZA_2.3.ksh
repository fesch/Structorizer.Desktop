...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result578486a3 "${phrases[@]}"; export result578486a3
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result1f36e637 "${reflexions[@]}"; export result1f36e637
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result2758fe70 "${setupReplies[@]}"; export result2758fe70
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result6e6c3152 "${result[@]}"; export result6e6c3152
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result551aa95a "${keywords[@]}"; export result551aa95a
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
set -A replies "${result2758fe70[@]}"
setupReflexions
set -A reflexions "${result1f36e637[@]}"
setupGoodByePhrases
set -A byePhrases "${result578486a3[@]}"
setupKeywords
set -A keyMap "${result551aa95a[@]}"
