...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result2ab85c68 "${result[@]}"; export result2ab85c68
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result2ecb0773 "${phrases[@]}"; export result2ecb0773
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result6e3e8cbb "${keywords[@]}"; export result6e3e8cbb
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultf6370ae9 "${reflexions[@]}"; export resultf6370ae9
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result71ae0823 "${setupReplies[@]}"; export result71ae0823
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
set -A replies "${result71ae0823[@]}"
setupReflexions
set -A reflexions "${resultf6370ae9[@]}"
setupGoodByePhrases
set -A byePhrases "${result2ecb0773[@]}"
setupKeywords
set -A keyMap "${result6e3e8cbb[@]}"
