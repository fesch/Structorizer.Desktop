...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result13eb8acf "${result[@]}"; export result13eb8acf
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result28ac3dc3 "${phrases[@]}"; export result28ac3dc3
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result32eebfca "${keywords[@]}"; export result32eebfca
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result23fe1d71 "${reflexions[@]}"; export result23fe1d71
}
...
# TODO: Check and revise the syntax of all expressions! 
    ...
    set -A result74a10858 "${setupReplies[@]}"; export result74a10858
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
set -A replies "${result74a10858[@]}"
setupReflexions
set -A reflexions "${result23fe1d71[@]}"
setupGoodByePhrases
set -A byePhrases "${result28ac3dc3[@]}"
setupKeywords
set -A keyMap "${result32eebfca[@]}"
