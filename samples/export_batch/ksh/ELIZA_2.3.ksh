...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resulte5557acc "${result[@]}"; export resulte5557acc
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result33f55c79 "${phrases[@]}"; export result33f55c79
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A resultef6c1b49 "${keywords[@]}"; export resultef6c1b49
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result49c52053 "${reflexions[@]}"; export result49c52053
}
...
# TODO: Check and revise the syntax of all expressions! 
 ...
 set -A result47726b6b "${setupReplies[@]}"; export result47726b6b
}
# = = = = 8< = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
...
setupReplies
set -A replies "${result47726b6b[@]}"
setupReflexions
set -A reflexions "${result49c52053[@]}"
setupGoodByePhrases
set -A byePhrases "${result33f55c79[@]}"
setupKeywords
set -A keyMap "${resultef6c1b49[@]}"
