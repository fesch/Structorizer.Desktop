...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array5c51c1ed[2] = {" i ", " i\'"};
		int index5c51c1ed;
		for (index5c51c1ed = 0; index5c51c1ed < 2; index5c51c1ed++) {
			char* word = array5c51c1ed[index5c51c1ed];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int countab339a2 = ???;
		int indexab339a2;
		for (indexab339a2 = 0; indexab339a2 < countab339a2; indexab339a2++) {
			char* pair[] = phrases[indexab339a2];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count3534f910 = ???;
		int index3534f910;
		for (index3534f910 = 0; index3534f910 < count3534f910; index3534f910++) {
			char* pair[] = flexions[index3534f910];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arrayc9e4a710[5] = {'.', ',', ';', '!', '?'};
		int indexc9e4a710;
		for (indexc9e4a710 = 0; indexc9e4a710 < 5; indexc9e4a710++) {
			char symbol = arrayc9e4a710[indexc9e4a710];
