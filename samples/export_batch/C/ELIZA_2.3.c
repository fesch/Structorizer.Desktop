...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array1ba47a16[2] = {" i ", " i\'"};
		int index1ba47a16;
		for (index1ba47a16 = 0; index1ba47a16 < 2; index1ba47a16++) {
			char* word = array1ba47a16[index1ba47a16];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int counte52589d8 = ???;
		int indexe52589d8;
		for (indexe52589d8 = 0; indexe52589d8 < counte52589d8; indexe52589d8++) {
			char* pair[] = phrases[indexe52589d8];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count1a9e5866 = ???;
		int index1a9e5866;
		for (index1a9e5866 = 0; index1a9e5866 < count1a9e5866; index1a9e5866++) {
			char* pair[] = flexions[index1a9e5866];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arraya017e182[5] = {'.', ',', ';', '!', '?'};
		int indexa017e182;
		for (indexa017e182 = 0; indexa017e182 < 5; indexa017e182++) {
			char symbol = arraya017e182[indexa017e182];
