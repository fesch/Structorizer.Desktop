...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array88d9547a[2] = {" i ", " i\'"};
		int index88d9547a;
		for (index88d9547a = 0; index88d9547a < 2; index88d9547a++) {
			char* word = array88d9547a[index88d9547a];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count304971f1 = ???;
		int index304971f1;
		for (index304971f1 = 0; index304971f1 < count304971f1; index304971f1++) {
			char* pair[] = phrases[index304971f1];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int countc336f761 = ???;
		int indexc336f761;
		for (indexc336f761 = 0; indexc336f761 < countc336f761; indexc336f761++) {
			char* pair[] = flexions[indexc336f761];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arraydc9b80a7[5] = {'.', ',', ';', '!', '?'};
		int indexdc9b80a7;
		for (indexdc9b80a7 = 0; indexdc9b80a7 < 5; indexdc9b80a7++) {
			char symbol = arraydc9b80a7[indexdc9b80a7];
