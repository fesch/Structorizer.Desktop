...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* arrayfc410752[2] = {" i ", " i\'"};
		int indexfc410752;
		for (indexfc410752 = 0; indexfc410752 < 2; indexfc410752++) {
			char* word = arrayfc410752[indexfc410752];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int countb372c271 = ???;
		int indexb372c271;
		for (indexb372c271 = 0; indexb372c271 < countb372c271; indexb372c271++) {
			char* pair[] = phrases[indexb372c271];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count8360d3c6 = ???;
		int index8360d3c6;
		for (index8360d3c6 = 0; index8360d3c6 < count8360d3c6; index8360d3c6++) {
			char* pair[] = flexions[index8360d3c6];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array8b99a883[5] = {'.', ',', ';', '!', '?'};
		int index8b99a883;
		for (index8b99a883 = 0; index8b99a883 < 5; index8b99a883++) {
			char symbol = array8b99a883[index8b99a883];
