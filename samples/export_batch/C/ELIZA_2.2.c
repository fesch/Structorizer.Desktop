...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array42eca56e[2] = {" i ", " i\'"};
		int index42eca56e;
		for (index42eca56e = 0; index42eca56e < 2; index42eca56e++) {
			char* word = array42eca56e[index42eca56e];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count3ecd23d9 = ???;
		int index3ecd23d9;
		for (index3ecd23d9 = 0; index3ecd23d9 < count3ecd23d9; index3ecd23d9++) {
			char* pair[] = phrases[index3ecd23d9];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int countcb0ed20 = ???;
		int indexcb0ed20;
		for (indexcb0ed20 = 0; indexcb0ed20 < countcb0ed20; indexcb0ed20++) {
			char* pair[] = flexions[indexcb0ed20];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array7403c468[5] = {'.', ',', ';', '!', '?'};
		int index7403c468;
		for (index7403c468 = 0; index7403c468 < 5; index7403c468++) {
			char symbol = array7403c468[index7403c468];
