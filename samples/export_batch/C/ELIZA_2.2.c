...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array95633cc3[2] = {" i ", " i\'"};
		int index95633cc3;
		for (index95633cc3 = 0; index95633cc3 < 2; index95633cc3++) {
			char* word = array95633cc3[index95633cc3];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int counteb07442b = ???;
		int indexeb07442b;
		for (indexeb07442b = 0; indexeb07442b < counteb07442b; indexeb07442b++) {
			char* pair[] = phrases[indexeb07442b];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int countece2ca1f = ???;
		int indexece2ca1f;
		for (indexece2ca1f = 0; indexece2ca1f < countece2ca1f; indexece2ca1f++) {
			char* pair[] = flexions[indexece2ca1f];
			left = "";
			right = result;
...
char* normalizeInput(char* sentence)
{
	...
	sentence = lowercase(sentence);
	{
		char array1f093bb[5] = {'.', ',', ';', '!', '?'};
		int index1f093bb;
		for (index1f093bb = 0; index1f093bb < 5; index1f093bb++) {
			char symbol = array1f093bb[index1f093bb];
