...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array7cbd213e[2] = {" i ", " i\'"};
		int index7cbd213e;
		for (index7cbd213e = 0; index7cbd213e < 2; index7cbd213e++) {
			char* word = array7cbd213e[index7cbd213e];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count43bd930a = ???;
		int index43bd930a;
		for (index43bd930a = 0; index43bd930a < count43bd930a; index43bd930a++) {
			char* pair[] = phrases[index43bd930a];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count8e24743 = ???;
		int index8e24743;
		for (index8e24743 = 0; index8e24743 < count8e24743; index8e24743++) {
			char* pair[] = flexions[index8e24743];
			left = "";
			right = result;
	...
	{
		char* array32eebfca[2] = {"  ", "|"};
		int index32eebfca;
		for (index32eebfca = 0; index32eebfca < 2; index32eebfca++) {
			char* str = array32eebfca[index32eebfca];
...
char* normalizeInput(char* sentence)
{
	...
	{
		char array1fc2b765[5] = {'.', ',', ';', '!', '?'};
		int index1fc2b765;
		for (index1fc2b765 = 0; index1fc2b765 < 5; index1fc2b765++) {
			char symbol = array1fc2b765[index1fc2b765];
