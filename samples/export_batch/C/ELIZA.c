...
char* adjustSpelling(char* sentence)
{
	...
	{
		char* array83c60cf6[2] = {" i ", " i\'"};
		int index83c60cf6;
		for (index83c60cf6 = 0; index83c60cf6 < 2; index83c60cf6++) {
			char* word = array83c60cf6[index83c60cf6];
...
bool checkGoodBye(char* text, char* phrases[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array phrases here! 
		int count46f590cd = ???;
		int index46f590cd;
		for (index46f590cd = 0; index46f590cd < count46f590cd; index46f590cd++) {
			char* pair[] = phrases[index46f590cd];
...
char* conjugateStrings(char* sentence, char* key, int keyPos, char* flexions[50][2])
{
	...
	// TODO: Find out and fill in the number of elements of the array flexions here! 
		int count43869bb = ???;
		int index43869bb;
		for (index43869bb = 0; index43869bb < count43869bb; index43869bb++) {
			char* pair[] = flexions[index43869bb];
			left = "";
			right = result;
	...
	{
		char* arrayfa73c29d[2] = {"  ", "|"};
		int indexfa73c29d;
		for (indexfa73c29d = 0; indexfa73c29d < 2; indexfa73c29d++) {
			char* str = arrayfa73c29d[indexfa73c29d];
...
char* normalizeInput(char* sentence)
{
	...
	{
		char arraya339dcd6[5] = {'.', ',', ';', '!', '?'};
		int indexa339dcd6;
		for (indexa339dcd6 = 0; indexa339dcd6 < 5; indexa339dcd6++) {
			char symbol = arraya339dcd6[indexa339dcd6];
