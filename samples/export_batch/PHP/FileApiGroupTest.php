<?php
// function readNumbers (generated by Structorizer 3.31-04) 
...
function readNumbers($fileName, $numbers, $maxNumbers)
{
	...
	} catch (Exception $eex9959488b) {
		$error = $ex9959488b->getMessage();
		throw new Exception();
	} finally {
...
<?php
// program ComputeSum (generated by Structorizer 3.31-04) 
...
// 	StructorizerFileAPI::fileClose($fileNo); 
	...
	} catch (Exception $eexb8b53538) {
		$failure = $exb8b53538->getMessage();
		echo failure;
		exit(-7);
	}
	$sum = 0.0;
...
<?php
// program DrawRandomHistogram (generated by Structorizer 3.31-04) 
...
if ($fileNo > 0)
{
	...
	} catch (Exception $eexe6f761c3) {
		$failure = $exe6f761c3->getMessage();
		echo failure;
	}
	if ($nObtained > 0)
	{
