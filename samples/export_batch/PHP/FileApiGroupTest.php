<?php
// function readNumbers (generated by Structorizer 3.32-20) 
...
function readNumbers($fileName, $numbers, $maxNumbers)
{
	...
	} catch (Exception $ex4eb7f003) {
		$error = $ex4eb7f003->getMessage();
		throw $ex4eb7f003;
	} finally {
...
// 	StructorizerFileAPI::fileClose($fileNo); 
	...
	} catch (Exception $ex66d1af89) {
		$failure = $ex66d1af89->getMessage();
		echo failure;
		exit(-7);
	}
	$sum = 0.0;
...
if ($fileNo > 0)
{
	...
	} catch (Exception $ex3ecd23d9) {
		$failure = $ex3ecd23d9->getMessage();
		echo failure;
	}
	if ($nObtained > 0)
	{
