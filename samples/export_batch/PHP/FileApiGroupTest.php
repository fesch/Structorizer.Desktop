<?php
// function readNumbers (generated by Structorizer 3.32-13) 
...
function readNumbers($fileName, $numbers, $maxNumbers)
{
	...
	} catch (Exception $eexb4857b3d) {
		$error = $exb4857b3d->getMessage();
		throw new Exception();
	} finally {
...
<?php
// program ComputeSum (generated by Structorizer 3.32-13) 
...
// 	StructorizerFileAPI::fileClose($fileNo); 
	...
	} catch (Exception $eexef12f24a) {
		$failure = $exef12f24a->getMessage();
		echo failure;
		exit(-7);
	}
	$sum = 0.0;
...
<?php
// program DrawRandomHistogram (generated by Structorizer 3.32-13) 
...
if ($fileNo > 0)
{
	...
	} catch (Exception $eexe793a903) {
		$failure = $exe793a903->getMessage();
		echo failure;
	}
	if ($nObtained > 0)
	{
