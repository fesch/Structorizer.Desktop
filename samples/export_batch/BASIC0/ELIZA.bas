...
1350   END IF
1360   DIM array49fc609f() AS String = {" i ", " i\'"}
1370   FOR EACH word IN array49fc609f
...
1930   DIM array1efed156() AS String = {"  ", "|"}
1940   FOR EACH str IN array1efed156
...
2140   DIM array68bbe345() AS FIXME_68bbe345 = {'.', ',', ';', '!', '?'}
2150   FOR EACH symbol IN array68bbe345
