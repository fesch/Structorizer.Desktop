 ...
 *      Kay Gürtzig     2025-09-02      Bugfix #1210: Precautions against unknown parameter types
 *
 ******************************************************************************************************
 *
 *      Comment:		/
			...
			if (!params.isEmpty() || resType != null || hasIncludes) {
				...
				if (!params.isEmpty()) {
					...
					for (Param param: params) {
						// START KGU#1193 2025-09-02: Bugfix #1210 Beare of null results
